...
def _check_optional_stream_queue_budget_sweep(
    ...
    live_runtime_adapter_payload_issue_queue_submit_blocked_canary_payload: dict[str, Any] = {}
    live_runtime_adapter_payload_issue_inflight_admission_blocked_canary_payload: dict[
        str,
        Any,
    ] = {}
    live_runtime_adapter_payload_issue_scheduler_dispatch_blocked_canary_payload: dict[
        str,
        Any,
    ] = {}
    live_runtime_adapter_payload_issue_command_packet_dry_run_payload: dict[str, Any] = {}
    live_runtime_adapter_payload_issue_transport_enqueue_blocked_canary_payload: dict[
        str,
        Any,
    ] = {}
    ...
    live_runtime_adapter_payload_issue_copy_descriptor_dry_run_payload: dict[str, Any] = {}
    live_runtime_adapter_payload_issue_copy_descriptor_submit_blocked_canary_payload: dict[
        str,
        Any,
    ] = {}
    live_runtime_adapter_payload_issue_copy_descriptor_dispatch_blocked_canary_payload: dict[
        str,
        Any,
    ] = {}
    live_runtime_adapter_payload_issue_copy_descriptor_execution_blocked_canary_payload: dict[
        str,
        Any,
    ] = {}
    live_runtime_adapter_payload_issue_copy_completion_blocked_canary_payload: dict[
        str,
        Any,
    ] = {}
    live_runtime_adapter_payload_issue_ready_credit_blocked_canary_payload: dict[
        str,
        Any,
    ] = {}
    live_runtime_adapter_payload_issue_residency_update_blocked_canary_payload: dict[
        str,
        Any,
    ] = {}
    live_runtime_adapter_payload_issue_payload_deref_blocked_canary_payload: dict[
        str,
        Any,
    ] = {}
    live_runtime_adapter_payload_issue_demand_hit_publication_blocked_canary_payload: dict[
        str,
        Any,
    ] = {}
    if len(failures) == queue_failure_base:
        try:
            ...
            live_runtime_adapter_payload_issue_queue_submit_blocked_canary_payload = (
                live_runtime_adapter_payload_issue_queue_submit_blocked_canary.as_dict()
            )
            ...
            live_runtime_adapter_payload_issue_inflight_admission_blocked_canary_payload = (
                live_runtime_adapter_payload_issue_inflight_admission_blocked_canary.as_dict()
            )
            ...
            live_runtime_adapter_payload_issue_scheduler_dispatch_blocked_canary_payload = (
                live_runtime_adapter_payload_issue_scheduler_dispatch_blocked_canary.as_dict()
            )
            ...
            live_runtime_adapter_payload_issue_command_packet_dry_run_payload = (
                live_runtime_adapter_payload_issue_command_packet_dry_run.as_dict()
            )
            ...
            live_runtime_adapter_payload_issue_copy_descriptor_dry_run_payload = (
                live_runtime_adapter_payload_issue_copy_descriptor_dry_run.as_dict()
            )
            ...
            live_runtime_adapter_payload_issue_copy_descriptor_submit_blocked_canary_payload = (
                live_runtime_adapter_payload_issue_copy_descriptor_submit_blocked_canary.as_dict()
            )
            ...
            live_runtime_adapter_payload_issue_copy_descriptor_dispatch_blocked_canary_payload = (
                live_runtime_adapter_payload_issue_copy_descriptor_dispatch_blocked_canary.as_dict()
            )
            ...
            live_runtime_adapter_payload_issue_copy_descriptor_execution_blocked_canary_payload = (
                live_runtime_adapter_payload_issue_copy_descriptor_execution_blocked_canary.as_dict()
            )
            ...
            live_runtime_adapter_payload_issue_copy_completion_blocked_canary_payload = (
                live_runtime_adapter_payload_issue_copy_completion_blocked_canary.as_dict()
            )
            ...
            live_runtime_adapter_payload_issue_ready_credit_blocked_canary_payload = (
                live_runtime_adapter_payload_issue_ready_credit_blocked_canary.as_dict()
            )
            ...
            live_runtime_adapter_payload_issue_residency_update_blocked_canary_payload = (
                live_runtime_adapter_payload_issue_residency_update_blocked_canary.as_dict()
            )
            ...
            live_runtime_adapter_payload_issue_payload_deref_blocked_canary_payload = (
                live_runtime_adapter_payload_issue_payload_deref_blocked_canary.as_dict()
            )
            ...
            live_runtime_adapter_payload_issue_demand_hit_publication_blocked_canary_payload = (
                live_runtime_adapter_payload_issue_demand_hit_publication_blocked_canary.as_dict()
            )
        except (TypeError, ValueError) as exc:
            if live_runtime_adapter_payload_issue_payload_deref_blocked_canary_payload:
                label = (
                    "stream_queue_budget_live_runtime_adapter_"
                    "payload_issue_demand_hit_publication_blocked_canary_invalid"
                )
            elif live_runtime_adapter_payload_issue_residency_update_blocked_canary_payload:
                label = (
                    "stream_queue_budget_live_runtime_adapter_"
                    "payload_issue_payload_deref_blocked_canary_invalid"
                )
            elif live_runtime_adapter_payload_issue_ready_credit_blocked_canary_payload:
                label = (
                    "stream_queue_budget_live_runtime_adapter_"
                    "payload_issue_residency_update_blocked_canary_invalid"
                )
            elif live_runtime_adapter_payload_issue_copy_completion_blocked_canary_payload:
                label = (
                    "stream_queue_budget_live_runtime_adapter_"
                    "payload_issue_ready_credit_blocked_canary_invalid"
                )
            elif live_runtime_adapter_payload_issue_copy_descriptor_execution_blocked_canary_payload:
                label = (
                    "stream_queue_budget_live_runtime_adapter_"
                    "payload_issue_copy_completion_blocked_canary_invalid"
                )
            elif live_runtime_adapter_payload_issue_copy_descriptor_dispatch_blocked_canary_payload:
                label = (
                    "stream_queue_budget_live_runtime_adapter_"
                    "payload_issue_copy_descriptor_execution_blocked_canary_invalid"
                )
            elif live_runtime_adapter_payload_issue_copy_descriptor_submit_blocked_canary_payload:
                label = (
                    "stream_queue_budget_live_runtime_adapter_"
                    "payload_issue_copy_descriptor_dispatch_blocked_canary_invalid"
                )
            elif live_runtime_adapter_payload_issue_copy_descriptor_dry_run_payload:
                label = (
                    "stream_queue_budget_live_runtime_adapter_"
                    "payload_issue_copy_descriptor_submit_blocked_canary_invalid"
                )
            elif live_runtime_adapter_payload_issue_transport_worker_dispatch_blocked_canary_payload:
                label = (
                    "stream_queue_budget_live_runtime_adapter_"
                    "payload_issue_copy_descriptor_dry_run_invalid"
                )
            elif live_runtime_adapter_payload_issue_transport_enqueue_blocked_canary_payload:
                label = (
                    "stream_queue_budget_live_runtime_adapter_"
            ...
            elif live_runtime_adapter_payload_issue_scheduler_dispatch_blocked_canary_payload:
                label = (
                    "stream_queue_budget_live_runtime_adapter_"
                    "payload_issue_command_packet_dry_run_invalid"
                )
            elif live_runtime_adapter_payload_issue_inflight_admission_blocked_canary_payload:
                label = (
                    "stream_queue_budget_live_runtime_adapter_"
                    "payload_issue_scheduler_dispatch_blocked_canary_invalid"
                )
            elif live_runtime_adapter_payload_issue_queue_submit_blocked_canary_payload:
                label = (
                    "stream_queue_budget_live_runtime_adapter_"
                    "payload_issue_inflight_admission_blocked_canary_invalid"
                )
            elif live_runtime_adapter_payload_issue_queue_entry_dry_run_payload:
                label = (
                    "stream_queue_budget_live_runtime_adapter_"
                    "payload_issue_queue_submit_blocked_canary_invalid"
                )
            elif live_runtime_adapter_payload_issue_executor_dry_run_payload:
                label = (
                    "stream_queue_budget_live_runtime_adapter_"
    ...
    return {
        ...
        **_prefixed_payload(
            "stream_queue_budget_live_runtime_adapter_payload_issue_queue_submit_blocked_canary",
            live_runtime_adapter_payload_issue_queue_submit_blocked_canary_payload,
        ),
        **_prefixed_payload(
            (
        ...
        **_prefixed_payload(
            "stream_queue_budget_live_runtime_adapter_payload_issue_copy_completion_blocked_canary",
            live_runtime_adapter_payload_issue_copy_completion_blocked_canary_payload,
        ),
        **_prefixed_payload(
            "stream_queue_budget_live_runtime_adapter_payload_issue_ready_credit_blocked_canary",
            live_runtime_adapter_payload_issue_ready_credit_blocked_canary_payload,
        ),
        **_prefixed_payload(
            "stream_queue_budget_live_runtime_adapter_payload_issue_residency_update_blocked_canary",
            live_runtime_adapter_payload_issue_residency_update_blocked_canary_payload,
        ),
        **_prefixed_payload(
            "stream_queue_budget_live_runtime_adapter_payload_issue_payload_deref_blocked_canary",
            live_runtime_adapter_payload_issue_payload_deref_blocked_canary_payload,
        ),
        **_prefixed_payload(
            (
