...
STREAM_QUEUE_BUDGET_LIVE_RUNTIME_ADAPTER_PAYLOAD_TRANSFER_TOGGLE_DISABLED_CANARY_FIELDS = (
    ...
    "stage",
    "status",
    "consumes_payloadless_instance_canary",
...
STREAM_QUEUE_BUDGET_LIVE_RUNTIME_ADAPTER_PAYLOAD_ISSUE_PLAN_DRY_RUN_FIELDS = (
    "present",
    "stage",
    "status",
    "consumes_payload_issue_request_blocked_canary",
...
STREAM_QUEUE_BUDGET_LIVE_RUNTIME_ADAPTER_PAYLOAD_ISSUE_EXECUTOR_DRY_RUN_FIELDS = (
    "present",
    "stage",
    "status",
    "consumes_payload_issue_plan_dry_run",
    "payload_issue_plan_status",
    "payload_issue_executor_schema",
    "payload_issue_executor_created",
    "payload_issue_plan_consumed",
    "request_source",
    "request_layer_idx",
    "request_expert_idx",
    "requested_payload_bytes",
...
STREAM_QUEUE_BUDGET_LIVE_RUNTIME_ADAPTER_PAYLOAD_ISSUE_QUEUE_ENTRY_DRY_RUN_FIELDS = (
    "present",
    "stage",
    "status",
    "consumes_payload_issue_executor_dry_run",
...
STREAM_QUEUE_BUDGET_LIVE_RUNTIME_ADAPTER_PAYLOAD_ISSUE_QUEUE_SUBMIT_BLOCKED_CANARY_FIELDS = (
    ...
    "stage",
    "status",
    "consumes_payload_issue_queue_entry_dry_run",
...
STREAM_QUEUE_BUDGET_LIVE_RUNTIME_ADAPTER_PAYLOAD_ISSUE_SCHEDULER_DISPATCH_BLOCKED_CANARY_FIELDS = (
    "present",
    "stage",
    "status",
    "consumes_payload_issue_inflight_admission_blocked_canary",
...
STREAM_QUEUE_BUDGET_LIVE_RUNTIME_ADAPTER_PAYLOAD_ISSUE_COMMAND_PACKET_DRY_RUN_FIELDS = (
    "present",
    "stage",
    "status",
    "consumes_payload_issue_scheduler_dispatch_blocked_canary",
    ...
    "command_packet_submitted",
    "command_packet_executed",
    "request_source",
    "request_layer_idx",
    "request_expert_idx",
    "requested_payload_bytes",
    ...
    lab_gate_status_summary = {
        ...
        **_copy_metric_block(
            ...
            input_prefix=(
                ...
                "payload_transfer_toggle_disabled_canary"
            ),
            output_prefix=(
                "prefetch_lab_default_stream_queue_budget_"
        ...
        **_copy_metric_block(
            ...
            input_prefix=(
                "stream_queue_budget_live_runtime_adapter_"
                "payload_issue_executor_dry_run"
            ),
            output_prefix=(
                "prefetch_lab_default_stream_queue_budget_"
        ...
        **_copy_metric_block(
            ...
            input_prefix=(
                "stream_queue_budget_live_runtime_adapter_"
                "payload_issue_queue_entry_dry_run"
            ),
            output_prefix=(
                "prefetch_lab_default_stream_queue_budget_"
        ...
        **_copy_metric_block(
        ...
        "prefetch_lab_default_stream_queue_budget_issued_payload_count": (
            _int_metric(
                prefetch_lab_default_full_fetch,
                "stream_queue_budget_issued_payload_count",
            )
        ),
        "prefetch_lab_default_stream_queue_budget_live_payload_runtime_enabled": (
            _bool_metric(
                prefetch_lab_default_full_fetch,
                "stream_queue_budget_live_payload_runtime_enabled",
            )
        ),
        ...
        "prefetch_lab_default_stream_queue_budget_payload_transfer_runtime_enabled": (
            _bool_metric(
                prefetch_lab_default_full_fetch,
                "stream_queue_budget_payload_transfer_runtime_enabled",
            )
        ),
        ...
        "prefetch_lab_default_stream_queue_budget_payload_deref_runtime_allowed": (
            _bool_metric(
                prefetch_lab_default_full_fetch,
                "stream_queue_budget_payload_deref_runtime_allowed",
            )
        ),
        ...
        "prefetch_lab_default_stream_queue_budget_full_fetch_runtime_allowed": (
            _bool_metric(
                prefetch_lab_default_full_fetch,
                "stream_queue_budget_full_fetch_runtime_allowed",
            )
        ),
        ...
        "prefetch_lab_default_stream_queue_budget_live_runtime_instantiated": (
            _bool_metric(
                prefetch_lab_default_full_fetch,
                "stream_queue_budget_live_runtime_instantiated",
            )
        ),
