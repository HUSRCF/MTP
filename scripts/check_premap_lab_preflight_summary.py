...
def _check_stream_queue_budget(summary: dict[str, Any], failures: list[str]) -> None:
    ...
    payload_issue_copy_descriptor_submit_prefix = (
        f"{prefix}_live_runtime_adapter_payload_issue_copy_descriptor_submit_blocked_canary"
    )
    expected_payload_issue_copy_descriptor_submit_status = (
        "blocked_by_payload_issue_copy_descriptor_dry_run:"
        f"{expected_payload_issue_copy_descriptor_status}"
    )
    if summary.get(f"{payload_issue_copy_descriptor_submit_prefix}_present") is not True:
        failures.append(f"{payload_issue_copy_descriptor_submit_prefix}_present_mismatch")
    if (
        summary.get(f"{payload_issue_copy_descriptor_submit_prefix}_stage")
        != "payload_cache_live_runtime_adapter_payload_issue_copy_descriptor_submit_blocked_canary"
    ):
        failures.append(f"{payload_issue_copy_descriptor_submit_prefix}_stage_mismatch")
    if (
        summary.get(f"{payload_issue_copy_descriptor_submit_prefix}_status")
        != expected_payload_issue_copy_descriptor_submit_status
    ):
        failures.append(f"{payload_issue_copy_descriptor_submit_prefix}_status_mismatch")
    if (
        summary.get(
            f"{payload_issue_copy_descriptor_submit_prefix}_consumes_payload_issue_copy_descriptor_dry_run",
        )
        is not True
    ):
        failures.append(
            f"{payload_issue_copy_descriptor_submit_prefix}_consumes_payload_issue_copy_descriptor_dry_run_mismatch",
        )
    if (
        summary.get(f"{payload_issue_copy_descriptor_submit_prefix}_payload_issue_copy_descriptor_status")
        != expected_payload_issue_copy_descriptor_status
    ):
        failures.append(
            f"{payload_issue_copy_descriptor_submit_prefix}_payload_issue_copy_descriptor_status_mismatch",
        )
    if (
        summary.get(
        ...
        failures.append(
            f"{payload_issue_copy_descriptor_submit_prefix}_payload_issue_copy_descriptor_submit_schema_mismatch",
        )
    for key in (
        ...
        if summary.get(f"{payload_issue_copy_descriptor_submit_prefix}_{key}") is not True:
            failures.append(f"{payload_issue_copy_descriptor_submit_prefix}_{key}_mismatch")
    for key in (
        "copy_descriptor_submit_allowed",
        "copy_descriptor_submitted",
        "copy_descriptor_executed",
    ):
        if summary.get(f"{payload_issue_copy_descriptor_submit_prefix}_{key}") is not False:
            failures.append(f"{payload_issue_copy_descriptor_submit_prefix}_{key}_mismatch")
    for key, expected in {
        "request_layer_idx": 0,
        "request_expert_idx": 0,
        ...
        if _int_metric(summary, f"{payload_issue_copy_descriptor_submit_prefix}_{key}") != expected:
            failures.append(f"{payload_issue_copy_descriptor_submit_prefix}_{key}_mismatch")
    if (
        summary.get(f"{payload_issue_copy_descriptor_submit_prefix}_request_source")
        != "queue_budget_first_model_passing_cell"
    ):
        failures.append(f"{payload_issue_copy_descriptor_submit_prefix}_request_source_mismatch")
    if (
        _float_metric(
            summary,
        ...
        failures.append(
            f"{payload_issue_copy_descriptor_submit_prefix}_source_queue_deadline_us_mismatch",
        )
    if summary.get(f"{payload_issue_copy_descriptor_submit_prefix}_decision") != "blocked":
        failures.append(f"{payload_issue_copy_descriptor_submit_prefix}_decision_mismatch")
    if (
        summary.get(f"{payload_issue_copy_descriptor_submit_prefix}_block_reason")
        != "payload_transfer_disabled"
    ):
        failures.append(f"{payload_issue_copy_descriptor_submit_prefix}_block_reason_mismatch")
    if (
        summary.get(f"{payload_issue_copy_descriptor_submit_prefix}_execution_mode")
        != "payload_cache_live_runtime_adapter_payload_issue_copy_descriptor_submit_blocked_canary"
    ):
        failures.append(f"{payload_issue_copy_descriptor_submit_prefix}_execution_mode_mismatch")
    for key in (
        "live_payload_runtime_enabled",
        "payload_transfer_runtime_enabled",
        "payload_deref_allowed",
    ...
    payload_issue_copy_descriptor_dispatch_prefix = (
        f"{prefix}_live_runtime_adapter_payload_issue_copy_descriptor_dispatch_blocked_canary"
    )
    expected_payload_issue_copy_descriptor_dispatch_status = (
        "blocked_by_payload_issue_copy_descriptor_submit_blocked_canary:"
        f"{expected_payload_issue_copy_descriptor_submit_status}"
    )
    if summary.get(f"{payload_issue_copy_descriptor_dispatch_prefix}_present") is not True:
        failures.append(f"{payload_issue_copy_descriptor_dispatch_prefix}_present_mismatch")
    if (
        summary.get(f"{payload_issue_copy_descriptor_dispatch_prefix}_stage")
        != "payload_cache_live_runtime_adapter_payload_issue_copy_descriptor_dispatch_blocked_canary"
    ):
        failures.append(f"{payload_issue_copy_descriptor_dispatch_prefix}_stage_mismatch")
    if (
        summary.get(f"{payload_issue_copy_descriptor_dispatch_prefix}_status")
        != expected_payload_issue_copy_descriptor_dispatch_status
    ):
        failures.append(f"{payload_issue_copy_descriptor_dispatch_prefix}_status_mismatch")
    if (
        summary.get(
            f"{payload_issue_copy_descriptor_dispatch_prefix}_consumes_payload_issue_copy_descriptor_submit_blocked_canary",
        )
        is not True
    ):
        failures.append(
            f"{payload_issue_copy_descriptor_dispatch_prefix}_consumes_payload_issue_copy_descriptor_submit_blocked_canary_mismatch",
        )
    if (
        summary.get(
        ...
        failures.append(
            f"{payload_issue_copy_descriptor_dispatch_prefix}_payload_issue_copy_descriptor_submit_status_mismatch",
        )
    if (
        summary.get(
        ...
        failures.append(
            f"{payload_issue_copy_descriptor_dispatch_prefix}_payload_issue_copy_descriptor_dispatch_schema_mismatch",
        )
    for key in (
        ...
        if summary.get(f"{payload_issue_copy_descriptor_dispatch_prefix}_{key}") is not True:
            failures.append(f"{payload_issue_copy_descriptor_dispatch_prefix}_{key}_mismatch")
    for key in (
        ...
        if summary.get(f"{payload_issue_copy_descriptor_dispatch_prefix}_{key}") is not False:
            failures.append(f"{payload_issue_copy_descriptor_dispatch_prefix}_{key}_mismatch")
    for key, expected in {
        "request_layer_idx": 0,
        "request_expert_idx": 0,
        ...
        if _int_metric(summary, f"{payload_issue_copy_descriptor_dispatch_prefix}_{key}") != expected:
            failures.append(f"{payload_issue_copy_descriptor_dispatch_prefix}_{key}_mismatch")
    if (
        summary.get(f"{payload_issue_copy_descriptor_dispatch_prefix}_request_source")
        != "queue_budget_first_model_passing_cell"
    ):
        failures.append(f"{payload_issue_copy_descriptor_dispatch_prefix}_request_source_mismatch")
    if (
        _float_metric(
            summary,
        ...
        failures.append(
            f"{payload_issue_copy_descriptor_dispatch_prefix}_source_queue_deadline_us_mismatch",
        )
    if summary.get(f"{payload_issue_copy_descriptor_dispatch_prefix}_decision") != "blocked":
        failures.append(f"{payload_issue_copy_descriptor_dispatch_prefix}_decision_mismatch")
    if (
        summary.get(f"{payload_issue_copy_descriptor_dispatch_prefix}_block_reason")
        != "payload_transfer_disabled"
    ):
        failures.append(f"{payload_issue_copy_descriptor_dispatch_prefix}_block_reason_mismatch")
    if (
        summary.get(f"{payload_issue_copy_descriptor_dispatch_prefix}_execution_mode")
        != "payload_cache_live_runtime_adapter_payload_issue_copy_descriptor_dispatch_blocked_canary"
    ):
        failures.append(f"{payload_issue_copy_descriptor_dispatch_prefix}_execution_mode_mismatch")
    for key in (
        "live_payload_runtime_enabled",
        "payload_transfer_runtime_enabled",
        "payload_deref_allowed",
    ...
    payload_issue_copy_descriptor_execution_prefix = (
        f"{prefix}_live_runtime_adapter_payload_issue_copy_descriptor_execution_blocked_canary"
    )
    expected_payload_issue_copy_descriptor_execution_status = (
        "blocked_by_payload_issue_copy_descriptor_dispatch_blocked_canary:"
        f"{expected_payload_issue_copy_descriptor_dispatch_status}"
    )
    if summary.get(f"{payload_issue_copy_descriptor_execution_prefix}_present") is not True:
        failures.append(f"{payload_issue_copy_descriptor_execution_prefix}_present_mismatch")
    if (
        summary.get(f"{payload_issue_copy_descriptor_execution_prefix}_stage")
        != "payload_cache_live_runtime_adapter_payload_issue_copy_descriptor_execution_blocked_canary"
    ):
        failures.append(f"{payload_issue_copy_descriptor_execution_prefix}_stage_mismatch")
    if (
        summary.get(f"{payload_issue_copy_descriptor_execution_prefix}_status")
        != expected_payload_issue_copy_descriptor_execution_status
    ):
        failures.append(f"{payload_issue_copy_descriptor_execution_prefix}_status_mismatch")
    if (
        summary.get(
            f"{payload_issue_copy_descriptor_execution_prefix}_consumes_payload_issue_copy_descriptor_dispatch_blocked_canary",
        )
        is not True
    ):
        failures.append(
            f"{payload_issue_copy_descriptor_execution_prefix}_consumes_payload_issue_copy_descriptor_dispatch_blocked_canary_mismatch",
        )
    if (
        summary.get(
        ...
        failures.append(
            f"{payload_issue_copy_descriptor_execution_prefix}_payload_issue_copy_descriptor_dispatch_status_mismatch",
        )
    if (
        summary.get(
        ...
        failures.append(
            f"{payload_issue_copy_descriptor_execution_prefix}_payload_issue_copy_descriptor_execution_schema_mismatch",
        )
    for key in (
        ...
        if summary.get(f"{payload_issue_copy_descriptor_execution_prefix}_{key}") is not True:
            failures.append(f"{payload_issue_copy_descriptor_execution_prefix}_{key}_mismatch")
    for key in (
        ...
        if summary.get(f"{payload_issue_copy_descriptor_execution_prefix}_{key}") is not False:
            failures.append(f"{payload_issue_copy_descriptor_execution_prefix}_{key}_mismatch")
    for key, expected in {
        "request_layer_idx": 0,
        "request_expert_idx": 0,
        ...
        if _int_metric(summary, f"{payload_issue_copy_descriptor_execution_prefix}_{key}") != expected:
            failures.append(f"{payload_issue_copy_descriptor_execution_prefix}_{key}_mismatch")
    if (
        summary.get(f"{payload_issue_copy_descriptor_execution_prefix}_request_source")
        != "queue_budget_first_model_passing_cell"
    ):
        failures.append(f"{payload_issue_copy_descriptor_execution_prefix}_request_source_mismatch")
    if (
        _float_metric(
            summary,
        ...
        failures.append(
            f"{payload_issue_copy_descriptor_execution_prefix}_source_queue_deadline_us_mismatch",
        )
    if summary.get(f"{payload_issue_copy_descriptor_execution_prefix}_decision") != "blocked":
        failures.append(f"{payload_issue_copy_descriptor_execution_prefix}_decision_mismatch")
    if (
        summary.get(f"{payload_issue_copy_descriptor_execution_prefix}_block_reason")
        != "payload_transfer_disabled"
    ):
        failures.append(f"{payload_issue_copy_descriptor_execution_prefix}_block_reason_mismatch")
    if (
        summary.get(f"{payload_issue_copy_descriptor_execution_prefix}_execution_mode")
        != "payload_cache_live_runtime_adapter_payload_issue_copy_descriptor_execution_blocked_canary"
    ):
        failures.append(f"{payload_issue_copy_descriptor_execution_prefix}_execution_mode_mismatch")
    for key in (
        "live_payload_runtime_enabled",
        "payload_transfer_runtime_enabled",
        "payload_deref_allowed",
    ...
    payload_issue_copy_completion_prefix = (
        f"{prefix}_live_runtime_adapter_payload_issue_copy_completion_blocked_canary"
    )
    expected_payload_issue_copy_completion_status = (
        "blocked_by_payload_issue_copy_descriptor_execution_blocked_canary:"
        f"{expected_payload_issue_copy_descriptor_execution_status}"
    )
    if summary.get(f"{payload_issue_copy_completion_prefix}_present") is not True:
        failures.append(f"{payload_issue_copy_completion_prefix}_present_mismatch")
    if (
        summary.get(f"{payload_issue_copy_completion_prefix}_stage")
        != "payload_cache_live_runtime_adapter_payload_issue_copy_completion_blocked_canary"
    ):
        failures.append(f"{payload_issue_copy_completion_prefix}_stage_mismatch")
    if (
        summary.get(f"{payload_issue_copy_completion_prefix}_status")
        != expected_payload_issue_copy_completion_status
    ):
        failures.append(f"{payload_issue_copy_completion_prefix}_status_mismatch")
    if (
        summary.get(
            f"{payload_issue_copy_completion_prefix}_consumes_payload_issue_copy_descriptor_execution_blocked_canary",
        )
        is not True
    ):
        failures.append(
            f"{payload_issue_copy_completion_prefix}_consumes_payload_issue_copy_descriptor_execution_blocked_canary_mismatch",
        )
    if (
        summary.get(
        ...
        failures.append(
            f"{payload_issue_copy_completion_prefix}_payload_issue_copy_descriptor_execution_status_mismatch",
        )
    if (
        summary.get(f"{payload_issue_copy_completion_prefix}_payload_issue_copy_completion_schema")
        != "payload_cache_runtime_payload_issue_copy_completion_v1"
    ):
        failures.append(
            f"{payload_issue_copy_completion_prefix}_payload_issue_copy_completion_schema_mismatch",
        )
    for key in (
        ...
        if summary.get(f"{payload_issue_copy_completion_prefix}_{key}") is not True:
            failures.append(f"{payload_issue_copy_completion_prefix}_{key}_mismatch")
    for key in (
        ...
        if summary.get(f"{payload_issue_copy_completion_prefix}_{key}") is not False:
            failures.append(f"{payload_issue_copy_completion_prefix}_{key}_mismatch")
    for key, expected in {
        "request_layer_idx": 0,
        "request_expert_idx": 0,
        ...
        if _int_metric(summary, f"{payload_issue_copy_completion_prefix}_{key}") != expected:
            failures.append(f"{payload_issue_copy_completion_prefix}_{key}_mismatch")
    if (
        summary.get(f"{payload_issue_copy_completion_prefix}_request_source")
        != "queue_budget_first_model_passing_cell"
    ):
        failures.append(f"{payload_issue_copy_completion_prefix}_request_source_mismatch")
    if (
        _float_metric(
            summary,
        ...
        failures.append(f"{payload_issue_copy_completion_prefix}_source_queue_deadline_us_mismatch")
    if summary.get(f"{payload_issue_copy_completion_prefix}_decision") != "blocked":
        failures.append(f"{payload_issue_copy_completion_prefix}_decision_mismatch")
    if (
        summary.get(f"{payload_issue_copy_completion_prefix}_block_reason")
        != "payload_transfer_disabled"
    ):
        failures.append(f"{payload_issue_copy_completion_prefix}_block_reason_mismatch")
    if (
        summary.get(f"{payload_issue_copy_completion_prefix}_execution_mode")
        != "payload_cache_live_runtime_adapter_payload_issue_copy_completion_blocked_canary"
    ):
        failures.append(f"{payload_issue_copy_completion_prefix}_execution_mode_mismatch")
    for key in (
        "live_payload_runtime_enabled",
        "payload_transfer_runtime_enabled",
        "payload_deref_allowed",
    ...
    payload_issue_ready_credit_prefix = (
        f"{prefix}_live_runtime_adapter_payload_issue_ready_credit_blocked_canary"
    )
    expected_payload_issue_ready_credit_status = (
        "blocked_by_payload_issue_copy_completion_blocked_canary:"
        f"{expected_payload_issue_copy_completion_status}"
    )
    if summary.get(f"{payload_issue_ready_credit_prefix}_present") is not True:
        failures.append(f"{payload_issue_ready_credit_prefix}_present_mismatch")
    if (
        summary.get(f"{payload_issue_ready_credit_prefix}_stage")
        != "payload_cache_live_runtime_adapter_payload_issue_ready_credit_blocked_canary"
    ):
        failures.append(f"{payload_issue_ready_credit_prefix}_stage_mismatch")
    if (
        summary.get(f"{payload_issue_ready_credit_prefix}_status")
        != expected_payload_issue_ready_credit_status
    ):
        failures.append(f"{payload_issue_ready_credit_prefix}_status_mismatch")
    if (
        summary.get(
            f"{payload_issue_ready_credit_prefix}_consumes_payload_issue_copy_completion_blocked_canary",
        )
        is not True
    ):
        failures.append(
            f"{payload_issue_ready_credit_prefix}_consumes_payload_issue_copy_completion_blocked_canary_mismatch",
        )
    if (
        summary.get(f"{payload_issue_ready_credit_prefix}_payload_issue_copy_completion_status")
        != expected_payload_issue_copy_completion_status
    ):
        failures.append(
            f"{payload_issue_ready_credit_prefix}_payload_issue_copy_completion_status_mismatch",
        )
    if (
        summary.get(f"{payload_issue_ready_credit_prefix}_payload_issue_ready_credit_schema")
        != "payload_cache_runtime_payload_issue_ready_credit_v1"
    ):
        failures.append(f"{payload_issue_ready_credit_prefix}_payload_issue_ready_credit_schema_mismatch")
    for key in (
        ...
        if summary.get(f"{payload_issue_ready_credit_prefix}_{key}") is not True:
            failures.append(f"{payload_issue_ready_credit_prefix}_{key}_mismatch")
    for key in (
        ...
        if summary.get(f"{payload_issue_ready_credit_prefix}_{key}") is not False:
            failures.append(f"{payload_issue_ready_credit_prefix}_{key}_mismatch")
    for key, expected in {
        "request_layer_idx": 0,
        "request_expert_idx": 0,
        ...
        if _int_metric(summary, f"{payload_issue_ready_credit_prefix}_{key}") != expected:
            failures.append(f"{payload_issue_ready_credit_prefix}_{key}_mismatch")
    if (
        summary.get(f"{payload_issue_ready_credit_prefix}_request_source")
        != "queue_budget_first_model_passing_cell"
    ):
        failures.append(f"{payload_issue_ready_credit_prefix}_request_source_mismatch")
    if (
        _float_metric(
            summary,
        ...
        failures.append(f"{payload_issue_ready_credit_prefix}_source_queue_deadline_us_mismatch")
    if summary.get(f"{payload_issue_ready_credit_prefix}_decision") != "blocked":
        failures.append(f"{payload_issue_ready_credit_prefix}_decision_mismatch")
    if (
        summary.get(f"{payload_issue_ready_credit_prefix}_block_reason")
        != "payload_transfer_disabled"
    ):
        failures.append(f"{payload_issue_ready_credit_prefix}_block_reason_mismatch")
    if (
        summary.get(f"{payload_issue_ready_credit_prefix}_execution_mode")
        != "payload_cache_live_runtime_adapter_payload_issue_ready_credit_blocked_canary"
    ):
        failures.append(f"{payload_issue_ready_credit_prefix}_execution_mode_mismatch")
    for key in (
        "live_payload_runtime_enabled",
        "payload_transfer_runtime_enabled",
        "payload_deref_allowed",
    ...
    payload_issue_residency_update_prefix = (
        f"{prefix}_live_runtime_adapter_payload_issue_residency_update_blocked_canary"
    )
    expected_payload_issue_residency_update_status = (
        "blocked_by_payload_issue_ready_credit_blocked_canary:"
        f"{expected_payload_issue_ready_credit_status}"
    )
    if summary.get(f"{payload_issue_residency_update_prefix}_present") is not True:
        failures.append(f"{payload_issue_residency_update_prefix}_present_mismatch")
    if (
        summary.get(f"{payload_issue_residency_update_prefix}_stage")
        != "payload_cache_live_runtime_adapter_payload_issue_residency_update_blocked_canary"
    ):
        failures.append(f"{payload_issue_residency_update_prefix}_stage_mismatch")
    if (
        summary.get(f"{payload_issue_residency_update_prefix}_status")
        != expected_payload_issue_residency_update_status
    ):
        failures.append(f"{payload_issue_residency_update_prefix}_status_mismatch")
    if (
        summary.get(
            f"{payload_issue_residency_update_prefix}_consumes_payload_issue_ready_credit_blocked_canary",
        )
        is not True
    ):
        failures.append(
            f"{payload_issue_residency_update_prefix}_consumes_payload_issue_ready_credit_blocked_canary_mismatch",
        )
    if (
        summary.get(f"{payload_issue_residency_update_prefix}_payload_issue_ready_credit_status")
        != expected_payload_issue_ready_credit_status
    ):
        failures.append(
            f"{payload_issue_residency_update_prefix}_payload_issue_ready_credit_status_mismatch",
        )
    if (
        summary.get(
        ...
        failures.append(
            f"{payload_issue_residency_update_prefix}_payload_issue_residency_update_schema_mismatch",
        )
    for key in (
        ...
        if summary.get(f"{payload_issue_residency_update_prefix}_{key}") is not True:
            failures.append(f"{payload_issue_residency_update_prefix}_{key}_mismatch")
    for key in (
        ...
        if summary.get(f"{payload_issue_residency_update_prefix}_{key}") is not False:
            failures.append(f"{payload_issue_residency_update_prefix}_{key}_mismatch")
    for key, expected in {
        "request_layer_idx": 0,
        "request_expert_idx": 0,
        ...
        if _int_metric(summary, f"{payload_issue_residency_update_prefix}_{key}") != expected:
            failures.append(f"{payload_issue_residency_update_prefix}_{key}_mismatch")
    if (
        summary.get(f"{payload_issue_residency_update_prefix}_request_source")
        != "queue_budget_first_model_passing_cell"
    ):
        failures.append(f"{payload_issue_residency_update_prefix}_request_source_mismatch")
    if (
        _float_metric(
            summary,
        ...
        failures.append(f"{payload_issue_residency_update_prefix}_source_queue_deadline_us_mismatch")
    if summary.get(f"{payload_issue_residency_update_prefix}_decision") != "blocked":
        failures.append(f"{payload_issue_residency_update_prefix}_decision_mismatch")
    if (
        summary.get(f"{payload_issue_residency_update_prefix}_block_reason")
        != "payload_transfer_disabled"
    ):
        failures.append(f"{payload_issue_residency_update_prefix}_block_reason_mismatch")
    if (
        summary.get(f"{payload_issue_residency_update_prefix}_execution_mode")
        != "payload_cache_live_runtime_adapter_payload_issue_residency_update_blocked_canary"
    ):
        failures.append(f"{payload_issue_residency_update_prefix}_execution_mode_mismatch")
    for key in (
        "live_payload_runtime_enabled",
        "payload_transfer_runtime_enabled",
        "payload_deref_allowed",
    ...
    payload_issue_payload_deref_prefix = (
        f"{prefix}_live_runtime_adapter_payload_issue_payload_deref_blocked_canary"
    )
    expected_payload_issue_payload_deref_status = (
        "blocked_by_payload_issue_residency_update_blocked_canary:"
        f"{expected_payload_issue_residency_update_status}"
    )
    if summary.get(f"{payload_issue_payload_deref_prefix}_present") is not True:
        failures.append(f"{payload_issue_payload_deref_prefix}_present_mismatch")
    if (
        summary.get(f"{payload_issue_payload_deref_prefix}_stage")
        != "payload_cache_live_runtime_adapter_payload_issue_payload_deref_blocked_canary"
    ):
        failures.append(f"{payload_issue_payload_deref_prefix}_stage_mismatch")
    if (
        summary.get(f"{payload_issue_payload_deref_prefix}_status")
        != expected_payload_issue_payload_deref_status
    ):
        failures.append(f"{payload_issue_payload_deref_prefix}_status_mismatch")
    if (
        summary.get(
            f"{payload_issue_payload_deref_prefix}_consumes_payload_issue_residency_update_blocked_canary",
        )
        is not True
    ):
        failures.append(
            f"{payload_issue_payload_deref_prefix}_consumes_payload_issue_residency_update_blocked_canary_mismatch",
        )
    if (
        summary.get(
        ...
        failures.append(
            f"{payload_issue_payload_deref_prefix}_payload_issue_residency_update_status_mismatch",
        )
    if (
        summary.get(f"{payload_issue_payload_deref_prefix}_payload_issue_payload_deref_schema")
        != "payload_cache_runtime_payload_issue_payload_deref_v1"
    ):
        failures.append(
            f"{payload_issue_payload_deref_prefix}_payload_issue_payload_deref_schema_mismatch",
        )
    for key in (
        ...
        if summary.get(f"{payload_issue_payload_deref_prefix}_{key}") is not True:
    ...
    for key, expected in {
        ...
        if _int_metric(summary, f"{payload_issue_payload_deref_prefix}_{key}") != expected:
            failures.append(f"{payload_issue_payload_deref_prefix}_{key}_mismatch")
    if (
        summary.get(f"{payload_issue_payload_deref_prefix}_request_source")
        != "queue_budget_first_model_passing_cell"
    ):
        failures.append(f"{payload_issue_payload_deref_prefix}_request_source_mismatch")
    if (
        _float_metric(
            summary,
        ...
        failures.append(f"{payload_issue_payload_deref_prefix}_source_queue_deadline_us_mismatch")
    if summary.get(f"{payload_issue_payload_deref_prefix}_decision") != "blocked":
        failures.append(f"{payload_issue_payload_deref_prefix}_decision_mismatch")
    if (
        summary.get(f"{payload_issue_payload_deref_prefix}_block_reason")
        != "payload_transfer_disabled"
    ):
        failures.append(f"{payload_issue_payload_deref_prefix}_block_reason_mismatch")
    if (
        summary.get(f"{payload_issue_payload_deref_prefix}_execution_mode")
        != "payload_cache_live_runtime_adapter_payload_issue_payload_deref_blocked_canary"
    ):
        failures.append(f"{payload_issue_payload_deref_prefix}_execution_mode_mismatch")
    for key in (
        "live_payload_runtime_enabled",
        "payload_transfer_runtime_enabled",
        "payload_deref_allowed",
