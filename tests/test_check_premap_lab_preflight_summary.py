    ...
    summary.update(
        {
            ...
            f"{prefix}_row_ok_count": row_count,
            f"{prefix}_rows_consumed": row_count,
            f"{prefix}_field_count": len(PAYLOADLESS_USEFUL_FIELDS),
            f"{prefix}_fields_per_row": len(PAYLOADLESS_USEFUL_FIELDS),
            f"{prefix}_useful_work_units": row_count
            * len(PAYLOADLESS_USEFUL_FIELDS),
            f"{prefix}_expected_useful_work_units": (
                row_count * len(PAYLOADLESS_USEFUL_FIELDS)
            ),
            f"{prefix}_useful_work_coverage": 1.0,
            f"{prefix}_useful_work_kind": (
...
def _summary() -> dict[str, object]:
    ...
    payload_issue_copy_descriptor_dispatch_prefix = (
        "prefetch_lab_default_stream_queue_budget_"
        "live_runtime_adapter_payload_issue_copy_descriptor_dispatch_blocked_canary"
    )
    payload_issue_copy_descriptor_submit_status = str(
        summary[f"{payload_issue_copy_descriptor_submit_prefix}_status"],
    )
    summary.update(
        {
            f"{payload_issue_copy_descriptor_dispatch_prefix}_present": True,
            f"{payload_issue_copy_descriptor_dispatch_prefix}_stage": (
                "payload_cache_live_runtime_adapter_"
                "payload_issue_copy_descriptor_dispatch_blocked_canary"
            ),
            f"{payload_issue_copy_descriptor_dispatch_prefix}_status": (
                "blocked_by_payload_issue_copy_descriptor_submit_blocked_canary:"
                f"{payload_issue_copy_descriptor_submit_status}"
            ),
            f"{payload_issue_copy_descriptor_dispatch_prefix}_consumes_payload_issue_copy_descriptor_submit_blocked_canary": True,
            f"{payload_issue_copy_descriptor_dispatch_prefix}_payload_issue_copy_descriptor_submit_status": (
                payload_issue_copy_descriptor_submit_status
            ),
            f"{payload_issue_copy_descriptor_dispatch_prefix}_payload_issue_copy_descriptor_dispatch_schema": (
                "payload_cache_runtime_payload_issue_copy_descriptor_dispatch_v1"
            ),
            f"{payload_issue_copy_descriptor_dispatch_prefix}_payload_issue_copy_descriptor_dispatch_canary_created": True,
            f"{payload_issue_copy_descriptor_dispatch_prefix}_payload_issue_copy_descriptor_submit_consumed": True,
            f"{payload_issue_copy_descriptor_dispatch_prefix}_copy_descriptor_dispatch_checked": True,
            f"{payload_issue_copy_descriptor_dispatch_prefix}_copy_descriptor_dispatch_rejected": True,
            f"{payload_issue_copy_descriptor_dispatch_prefix}_copy_descriptor_dispatch_allowed": False,
            f"{payload_issue_copy_descriptor_dispatch_prefix}_copy_descriptor_dispatched": False,
            f"{payload_issue_copy_descriptor_dispatch_prefix}_copy_descriptor_submitted": False,
            f"{payload_issue_copy_descriptor_dispatch_prefix}_copy_descriptor_executed": False,
            f"{payload_issue_copy_descriptor_dispatch_prefix}_request_source": summary[
                f"{payload_issue_copy_descriptor_submit_prefix}_request_source"
            ],
            f"{payload_issue_copy_descriptor_dispatch_prefix}_request_layer_idx": summary[
                f"{payload_issue_copy_descriptor_submit_prefix}_request_layer_idx"
            ],
            f"{payload_issue_copy_descriptor_dispatch_prefix}_request_expert_idx": summary[
                f"{payload_issue_copy_descriptor_submit_prefix}_request_expert_idx"
            ],
            f"{payload_issue_copy_descriptor_dispatch_prefix}_requested_payload_bytes": summary[
                f"{payload_issue_copy_descriptor_submit_prefix}_requested_payload_bytes"
            ],
            f"{payload_issue_copy_descriptor_dispatch_prefix}_source_issue_packet_count": summary[
                f"{payload_issue_copy_descriptor_submit_prefix}_source_issue_packet_count"
            ],
            f"{payload_issue_copy_descriptor_dispatch_prefix}_source_issue_unique_key_count": summary[
                f"{payload_issue_copy_descriptor_submit_prefix}_source_issue_unique_key_count"
            ],
            f"{payload_issue_copy_descriptor_dispatch_prefix}_source_queue_budget_capacity": summary[
                f"{payload_issue_copy_descriptor_submit_prefix}_source_queue_budget_capacity"
            ],
            f"{payload_issue_copy_descriptor_dispatch_prefix}_source_issue_lead_tokens": summary[
                f"{payload_issue_copy_descriptor_submit_prefix}_source_issue_lead_tokens"
            ],
            f"{payload_issue_copy_descriptor_dispatch_prefix}_source_queue_deadline_us": summary[
                f"{payload_issue_copy_descriptor_submit_prefix}_source_queue_deadline_us"
            ],
            f"{payload_issue_copy_descriptor_dispatch_prefix}_planned_issue_count": 0,
            f"{payload_issue_copy_descriptor_dispatch_prefix}_scheduled_issue_count": 0,
            f"{payload_issue_copy_descriptor_dispatch_prefix}_queued_issue_count": 0,
            f"{payload_issue_copy_descriptor_dispatch_prefix}_submitted_issue_count": 0,
            f"{payload_issue_copy_descriptor_dispatch_prefix}_inflight_issue_count": 0,
            f"{payload_issue_copy_descriptor_dispatch_prefix}_dispatched_issue_count": 0,
            f"{payload_issue_copy_descriptor_dispatch_prefix}_command_packet_count": 0,
            f"{payload_issue_copy_descriptor_dispatch_prefix}_transport_work_count": 0,
            f"{payload_issue_copy_descriptor_dispatch_prefix}_transport_worker_dispatch_count": 0,
            f"{payload_issue_copy_descriptor_dispatch_prefix}_copy_descriptor_count": 0,
            f"{payload_issue_copy_descriptor_dispatch_prefix}_issued_payload_count": 0,
            f"{payload_issue_copy_descriptor_dispatch_prefix}_payload_bytes": 0,
            f"{payload_issue_copy_descriptor_dispatch_prefix}_decision": "blocked",
            f"{payload_issue_copy_descriptor_dispatch_prefix}_block_reason": (
                "payload_transfer_disabled"
            ),
            f"{payload_issue_copy_descriptor_dispatch_prefix}_execution_mode": (
                "payload_cache_live_runtime_adapter_"
                "payload_issue_copy_descriptor_dispatch_blocked_canary"
            ),
        },
    ...
    for key in (
        ...
        summary[f"{payload_issue_copy_descriptor_dispatch_prefix}_{key}"] = False
    payload_issue_copy_descriptor_execution_prefix = (
        "prefetch_lab_default_stream_queue_budget_"
        "live_runtime_adapter_payload_issue_copy_descriptor_execution_blocked_canary"
    )
    payload_issue_copy_descriptor_dispatch_status = str(
        summary[f"{payload_issue_copy_descriptor_dispatch_prefix}_status"],
    )
    summary.update(
        {
            f"{payload_issue_copy_descriptor_execution_prefix}_present": True,
            f"{payload_issue_copy_descriptor_execution_prefix}_stage": (
                "payload_cache_live_runtime_adapter_"
                "payload_issue_copy_descriptor_execution_blocked_canary"
            ),
            f"{payload_issue_copy_descriptor_execution_prefix}_status": (
                "blocked_by_payload_issue_copy_descriptor_dispatch_blocked_canary:"
                f"{payload_issue_copy_descriptor_dispatch_status}"
            ),
            f"{payload_issue_copy_descriptor_execution_prefix}_consumes_payload_issue_copy_descriptor_dispatch_blocked_canary": True,
            f"{payload_issue_copy_descriptor_execution_prefix}_payload_issue_copy_descriptor_dispatch_status": (
                payload_issue_copy_descriptor_dispatch_status
            ),
            f"{payload_issue_copy_descriptor_execution_prefix}_payload_issue_copy_descriptor_execution_schema": (
                "payload_cache_runtime_payload_issue_copy_descriptor_execution_v1"
            ),
            f"{payload_issue_copy_descriptor_execution_prefix}_payload_issue_copy_descriptor_execution_canary_created": True,
            f"{payload_issue_copy_descriptor_execution_prefix}_payload_issue_copy_descriptor_dispatch_consumed": True,
            f"{payload_issue_copy_descriptor_execution_prefix}_copy_descriptor_execution_checked": True,
            f"{payload_issue_copy_descriptor_execution_prefix}_copy_descriptor_execution_rejected": True,
            f"{payload_issue_copy_descriptor_execution_prefix}_copy_descriptor_execution_allowed": False,
            f"{payload_issue_copy_descriptor_execution_prefix}_copy_descriptor_dispatched": False,
            f"{payload_issue_copy_descriptor_execution_prefix}_copy_descriptor_submitted": False,
            f"{payload_issue_copy_descriptor_execution_prefix}_copy_descriptor_executed": False,
            f"{payload_issue_copy_descriptor_execution_prefix}_request_source": summary[
                f"{payload_issue_copy_descriptor_dispatch_prefix}_request_source"
            ],
            f"{payload_issue_copy_descriptor_execution_prefix}_request_layer_idx": summary[
                f"{payload_issue_copy_descriptor_dispatch_prefix}_request_layer_idx"
            ],
            f"{payload_issue_copy_descriptor_execution_prefix}_request_expert_idx": summary[
                f"{payload_issue_copy_descriptor_dispatch_prefix}_request_expert_idx"
            ],
            f"{payload_issue_copy_descriptor_execution_prefix}_requested_payload_bytes": summary[
                f"{payload_issue_copy_descriptor_dispatch_prefix}_requested_payload_bytes"
            ],
            f"{payload_issue_copy_descriptor_execution_prefix}_source_issue_packet_count": summary[
                f"{payload_issue_copy_descriptor_dispatch_prefix}_source_issue_packet_count"
            ],
            f"{payload_issue_copy_descriptor_execution_prefix}_source_issue_unique_key_count": summary[
                f"{payload_issue_copy_descriptor_dispatch_prefix}_source_issue_unique_key_count"
            ],
            f"{payload_issue_copy_descriptor_execution_prefix}_source_queue_budget_capacity": summary[
                f"{payload_issue_copy_descriptor_dispatch_prefix}_source_queue_budget_capacity"
            ],
            f"{payload_issue_copy_descriptor_execution_prefix}_source_issue_lead_tokens": summary[
                f"{payload_issue_copy_descriptor_dispatch_prefix}_source_issue_lead_tokens"
            ],
            f"{payload_issue_copy_descriptor_execution_prefix}_source_queue_deadline_us": summary[
                f"{payload_issue_copy_descriptor_dispatch_prefix}_source_queue_deadline_us"
            ],
            f"{payload_issue_copy_descriptor_execution_prefix}_planned_issue_count": 0,
            f"{payload_issue_copy_descriptor_execution_prefix}_scheduled_issue_count": 0,
            f"{payload_issue_copy_descriptor_execution_prefix}_queued_issue_count": 0,
            f"{payload_issue_copy_descriptor_execution_prefix}_submitted_issue_count": 0,
            f"{payload_issue_copy_descriptor_execution_prefix}_inflight_issue_count": 0,
            f"{payload_issue_copy_descriptor_execution_prefix}_dispatched_issue_count": 0,
            f"{payload_issue_copy_descriptor_execution_prefix}_command_packet_count": 0,
            f"{payload_issue_copy_descriptor_execution_prefix}_transport_work_count": 0,
            f"{payload_issue_copy_descriptor_execution_prefix}_transport_worker_dispatch_count": 0,
            f"{payload_issue_copy_descriptor_execution_prefix}_copy_descriptor_count": 0,
            f"{payload_issue_copy_descriptor_execution_prefix}_issued_payload_count": 0,
            f"{payload_issue_copy_descriptor_execution_prefix}_payload_bytes": 0,
            f"{payload_issue_copy_descriptor_execution_prefix}_decision": "blocked",
            f"{payload_issue_copy_descriptor_execution_prefix}_block_reason": (
                "payload_transfer_disabled"
            ),
            f"{payload_issue_copy_descriptor_execution_prefix}_execution_mode": (
                "payload_cache_live_runtime_adapter_"
                "payload_issue_copy_descriptor_execution_blocked_canary"
            ),
        },
    ...
    for key in (
        ...
        summary[f"{payload_issue_copy_descriptor_execution_prefix}_{key}"] = False
    payload_issue_copy_completion_prefix = (
        "prefetch_lab_default_stream_queue_budget_"
        "live_runtime_adapter_payload_issue_copy_completion_blocked_canary"
    )
    payload_issue_copy_descriptor_execution_status = str(
        summary[f"{payload_issue_copy_descriptor_execution_prefix}_status"],
    )
    summary.update(
        {
            f"{payload_issue_copy_completion_prefix}_present": True,
            f"{payload_issue_copy_completion_prefix}_stage": (
                "payload_cache_live_runtime_adapter_"
                "payload_issue_copy_completion_blocked_canary"
            ),
            f"{payload_issue_copy_completion_prefix}_status": (
                "blocked_by_payload_issue_copy_descriptor_execution_blocked_canary:"
                f"{payload_issue_copy_descriptor_execution_status}"
            ),
            f"{payload_issue_copy_completion_prefix}_consumes_payload_issue_copy_descriptor_execution_blocked_canary": True,
            f"{payload_issue_copy_completion_prefix}_payload_issue_copy_descriptor_execution_status": (
                payload_issue_copy_descriptor_execution_status
            ),
            f"{payload_issue_copy_completion_prefix}_payload_issue_copy_completion_schema": (
                "payload_cache_runtime_payload_issue_copy_completion_v1"
            ),
            f"{payload_issue_copy_completion_prefix}_payload_issue_copy_completion_canary_created": True,
            f"{payload_issue_copy_completion_prefix}_payload_issue_copy_descriptor_execution_consumed": True,
            f"{payload_issue_copy_completion_prefix}_copy_completion_checked": True,
            f"{payload_issue_copy_completion_prefix}_copy_completion_rejected": True,
            f"{payload_issue_copy_completion_prefix}_copy_completion_allowed": False,
            f"{payload_issue_copy_completion_prefix}_copy_completed": False,
            f"{payload_issue_copy_completion_prefix}_copy_descriptor_dispatched": False,
            f"{payload_issue_copy_completion_prefix}_copy_descriptor_submitted": False,
            f"{payload_issue_copy_completion_prefix}_copy_descriptor_executed": False,
            f"{payload_issue_copy_completion_prefix}_request_source": summary[
                f"{payload_issue_copy_descriptor_execution_prefix}_request_source"
            ],
            f"{payload_issue_copy_completion_prefix}_request_layer_idx": summary[
                f"{payload_issue_copy_descriptor_execution_prefix}_request_layer_idx"
            ],
            f"{payload_issue_copy_completion_prefix}_request_expert_idx": summary[
                f"{payload_issue_copy_descriptor_execution_prefix}_request_expert_idx"
            ],
            f"{payload_issue_copy_completion_prefix}_requested_payload_bytes": summary[
                f"{payload_issue_copy_descriptor_execution_prefix}_requested_payload_bytes"
            ],
            f"{payload_issue_copy_completion_prefix}_source_issue_packet_count": summary[
                f"{payload_issue_copy_descriptor_execution_prefix}_source_issue_packet_count"
            ],
            f"{payload_issue_copy_completion_prefix}_source_issue_unique_key_count": summary[
                f"{payload_issue_copy_descriptor_execution_prefix}_source_issue_unique_key_count"
            ],
            f"{payload_issue_copy_completion_prefix}_source_queue_budget_capacity": summary[
                f"{payload_issue_copy_descriptor_execution_prefix}_source_queue_budget_capacity"
            ],
            f"{payload_issue_copy_completion_prefix}_source_issue_lead_tokens": summary[
                f"{payload_issue_copy_descriptor_execution_prefix}_source_issue_lead_tokens"
            ],
            f"{payload_issue_copy_completion_prefix}_source_queue_deadline_us": summary[
                f"{payload_issue_copy_descriptor_execution_prefix}_source_queue_deadline_us"
            ],
            f"{payload_issue_copy_completion_prefix}_planned_issue_count": 0,
            f"{payload_issue_copy_completion_prefix}_scheduled_issue_count": 0,
            f"{payload_issue_copy_completion_prefix}_queued_issue_count": 0,
            f"{payload_issue_copy_completion_prefix}_submitted_issue_count": 0,
            f"{payload_issue_copy_completion_prefix}_inflight_issue_count": 0,
            f"{payload_issue_copy_completion_prefix}_dispatched_issue_count": 0,
            f"{payload_issue_copy_completion_prefix}_command_packet_count": 0,
            f"{payload_issue_copy_completion_prefix}_transport_work_count": 0,
            f"{payload_issue_copy_completion_prefix}_transport_worker_dispatch_count": 0,
            f"{payload_issue_copy_completion_prefix}_copy_descriptor_count": 0,
            f"{payload_issue_copy_completion_prefix}_copy_completion_count": 0,
            f"{payload_issue_copy_completion_prefix}_issued_payload_count": 0,
            f"{payload_issue_copy_completion_prefix}_payload_bytes": 0,
            f"{payload_issue_copy_completion_prefix}_decision": "blocked",
            f"{payload_issue_copy_completion_prefix}_block_reason": "payload_transfer_disabled",
            f"{payload_issue_copy_completion_prefix}_execution_mode": (
    ...
    for key in (
        ...
        summary[f"{payload_issue_copy_completion_prefix}_{key}"] = False
    payload_issue_ready_credit_prefix = (
        "prefetch_lab_default_stream_queue_budget_"
        "live_runtime_adapter_payload_issue_ready_credit_blocked_canary"
    )
    payload_issue_copy_completion_status = str(
        summary[f"{payload_issue_copy_completion_prefix}_status"],
    )
    summary.update(
        {
            f"{payload_issue_ready_credit_prefix}_present": True,
            f"{payload_issue_ready_credit_prefix}_stage": (
                "payload_cache_live_runtime_adapter_payload_issue_ready_credit_blocked_canary"
            ),
            f"{payload_issue_ready_credit_prefix}_status": (
                "blocked_by_payload_issue_copy_completion_blocked_canary:"
                f"{payload_issue_copy_completion_status}"
            ),
            f"{payload_issue_ready_credit_prefix}_consumes_payload_issue_copy_completion_blocked_canary": True,
            f"{payload_issue_ready_credit_prefix}_payload_issue_copy_completion_status": (
                payload_issue_copy_completion_status
            ),
            f"{payload_issue_ready_credit_prefix}_payload_issue_ready_credit_schema": (
                "payload_cache_runtime_payload_issue_ready_credit_v1"
            ),
            f"{payload_issue_ready_credit_prefix}_payload_issue_ready_credit_canary_created": True,
            f"{payload_issue_ready_credit_prefix}_payload_issue_copy_completion_consumed": True,
            f"{payload_issue_ready_credit_prefix}_ready_credit_checked": True,
            f"{payload_issue_ready_credit_prefix}_ready_credit_rejected": True,
            f"{payload_issue_ready_credit_prefix}_ready_credit_allowed": False,
            f"{payload_issue_ready_credit_prefix}_ready_credit_granted": False,
            f"{payload_issue_ready_credit_prefix}_ready_before_demand_credit_granted": False,
            f"{payload_issue_ready_credit_prefix}_real_payload_ready": False,
            f"{payload_issue_ready_credit_prefix}_copy_completed": False,
            f"{payload_issue_ready_credit_prefix}_copy_descriptor_dispatched": False,
            f"{payload_issue_ready_credit_prefix}_copy_descriptor_submitted": False,
            f"{payload_issue_ready_credit_prefix}_copy_descriptor_executed": False,
            f"{payload_issue_ready_credit_prefix}_request_source": summary[
                f"{payload_issue_copy_completion_prefix}_request_source"
            ],
            f"{payload_issue_ready_credit_prefix}_request_layer_idx": summary[
                f"{payload_issue_copy_completion_prefix}_request_layer_idx"
            ],
            f"{payload_issue_ready_credit_prefix}_request_expert_idx": summary[
                f"{payload_issue_copy_completion_prefix}_request_expert_idx"
            ],
            f"{payload_issue_ready_credit_prefix}_requested_payload_bytes": summary[
                f"{payload_issue_copy_completion_prefix}_requested_payload_bytes"
            ],
            f"{payload_issue_ready_credit_prefix}_source_issue_packet_count": summary[
                f"{payload_issue_copy_completion_prefix}_source_issue_packet_count"
            ],
            f"{payload_issue_ready_credit_prefix}_source_issue_unique_key_count": summary[
                f"{payload_issue_copy_completion_prefix}_source_issue_unique_key_count"
            ],
            f"{payload_issue_ready_credit_prefix}_source_queue_budget_capacity": summary[
                f"{payload_issue_copy_completion_prefix}_source_queue_budget_capacity"
            ],
            f"{payload_issue_ready_credit_prefix}_source_issue_lead_tokens": summary[
                f"{payload_issue_copy_completion_prefix}_source_issue_lead_tokens"
            ],
            f"{payload_issue_ready_credit_prefix}_source_queue_deadline_us": summary[
                f"{payload_issue_copy_completion_prefix}_source_queue_deadline_us"
            ],
            f"{payload_issue_ready_credit_prefix}_planned_issue_count": 0,
            f"{payload_issue_ready_credit_prefix}_scheduled_issue_count": 0,
            f"{payload_issue_ready_credit_prefix}_queued_issue_count": 0,
            f"{payload_issue_ready_credit_prefix}_submitted_issue_count": 0,
            f"{payload_issue_ready_credit_prefix}_inflight_issue_count": 0,
            f"{payload_issue_ready_credit_prefix}_dispatched_issue_count": 0,
            f"{payload_issue_ready_credit_prefix}_command_packet_count": 0,
            f"{payload_issue_ready_credit_prefix}_transport_work_count": 0,
            f"{payload_issue_ready_credit_prefix}_transport_worker_dispatch_count": 0,
            f"{payload_issue_ready_credit_prefix}_copy_descriptor_count": 0,
            f"{payload_issue_ready_credit_prefix}_copy_completion_count": 0,
            f"{payload_issue_ready_credit_prefix}_ready_credit_count": 0,
            f"{payload_issue_ready_credit_prefix}_issued_payload_count": 0,
            f"{payload_issue_ready_credit_prefix}_payload_bytes": 0,
            f"{payload_issue_ready_credit_prefix}_decision": "blocked",
            f"{payload_issue_ready_credit_prefix}_block_reason": "payload_transfer_disabled",
            f"{payload_issue_ready_credit_prefix}_execution_mode": (
                "payload_cache_live_runtime_adapter_payload_issue_ready_credit_blocked_canary"
            ),
        },
    )
    for key in (
        ...
        summary[f"{payload_issue_ready_credit_prefix}_{key}"] = False
    payload_issue_residency_update_prefix = (
        "prefetch_lab_default_stream_queue_budget_"
        "live_runtime_adapter_payload_issue_residency_update_blocked_canary"
    )
    payload_issue_ready_credit_status = str(
        summary[f"{payload_issue_ready_credit_prefix}_status"],
    )
    summary.update(
        {
            f"{payload_issue_residency_update_prefix}_present": True,
            f"{payload_issue_residency_update_prefix}_stage": (
                "payload_cache_live_runtime_adapter_payload_issue_residency_update_blocked_canary"
            ),
            f"{payload_issue_residency_update_prefix}_status": (
                "blocked_by_payload_issue_ready_credit_blocked_canary:"
                f"{payload_issue_ready_credit_status}"
            ),
            f"{payload_issue_residency_update_prefix}_consumes_payload_issue_ready_credit_blocked_canary": True,
            f"{payload_issue_residency_update_prefix}_payload_issue_ready_credit_status": (
                payload_issue_ready_credit_status
            ),
            f"{payload_issue_residency_update_prefix}_payload_issue_residency_update_schema": (
                "payload_cache_runtime_payload_issue_residency_update_v1"
            ),
            f"{payload_issue_residency_update_prefix}_payload_issue_residency_update_canary_created": True,
            f"{payload_issue_residency_update_prefix}_payload_issue_ready_credit_consumed": True,
            f"{payload_issue_residency_update_prefix}_residency_update_checked": True,
            f"{payload_issue_residency_update_prefix}_residency_update_rejected": True,
            f"{payload_issue_residency_update_prefix}_residency_update_allowed": False,
            f"{payload_issue_residency_update_prefix}_residency_updated": False,
            f"{payload_issue_residency_update_prefix}_payload_marked_resident": False,
            f"{payload_issue_residency_update_prefix}_resident_payload_ready": False,
            f"{payload_issue_residency_update_prefix}_ready_credit_granted": False,
            f"{payload_issue_residency_update_prefix}_ready_before_demand_credit_granted": False,
            f"{payload_issue_residency_update_prefix}_real_payload_ready": False,
            f"{payload_issue_residency_update_prefix}_copy_completed": False,
            f"{payload_issue_residency_update_prefix}_request_source": summary[
                f"{payload_issue_ready_credit_prefix}_request_source"
            ],
            f"{payload_issue_residency_update_prefix}_request_layer_idx": summary[
                f"{payload_issue_ready_credit_prefix}_request_layer_idx"
            ],
            f"{payload_issue_residency_update_prefix}_request_expert_idx": summary[
                f"{payload_issue_ready_credit_prefix}_request_expert_idx"
            ],
            f"{payload_issue_residency_update_prefix}_requested_payload_bytes": summary[
                f"{payload_issue_ready_credit_prefix}_requested_payload_bytes"
            ],
            f"{payload_issue_residency_update_prefix}_source_issue_packet_count": summary[
                f"{payload_issue_ready_credit_prefix}_source_issue_packet_count"
            ],
            f"{payload_issue_residency_update_prefix}_source_issue_unique_key_count": summary[
                f"{payload_issue_ready_credit_prefix}_source_issue_unique_key_count"
            ],
            f"{payload_issue_residency_update_prefix}_source_queue_budget_capacity": summary[
                f"{payload_issue_ready_credit_prefix}_source_queue_budget_capacity"
            ],
            f"{payload_issue_residency_update_prefix}_source_issue_lead_tokens": summary[
                f"{payload_issue_ready_credit_prefix}_source_issue_lead_tokens"
            ],
            f"{payload_issue_residency_update_prefix}_source_queue_deadline_us": summary[
                f"{payload_issue_ready_credit_prefix}_source_queue_deadline_us"
            ],
            f"{payload_issue_residency_update_prefix}_planned_issue_count": 0,
            f"{payload_issue_residency_update_prefix}_scheduled_issue_count": 0,
            f"{payload_issue_residency_update_prefix}_queued_issue_count": 0,
            f"{payload_issue_residency_update_prefix}_submitted_issue_count": 0,
            f"{payload_issue_residency_update_prefix}_inflight_issue_count": 0,
            f"{payload_issue_residency_update_prefix}_dispatched_issue_count": 0,
            f"{payload_issue_residency_update_prefix}_command_packet_count": 0,
            f"{payload_issue_residency_update_prefix}_transport_work_count": 0,
            f"{payload_issue_residency_update_prefix}_transport_worker_dispatch_count": 0,
            f"{payload_issue_residency_update_prefix}_copy_descriptor_count": 0,
            f"{payload_issue_residency_update_prefix}_copy_completion_count": 0,
            f"{payload_issue_residency_update_prefix}_ready_credit_count": 0,
            f"{payload_issue_residency_update_prefix}_residency_update_count": 0,
            f"{payload_issue_residency_update_prefix}_resident_payload_count": 0,
            f"{payload_issue_residency_update_prefix}_issued_payload_count": 0,
            f"{payload_issue_residency_update_prefix}_payload_bytes": 0,
            f"{payload_issue_residency_update_prefix}_resident_payload_bytes": 0,
            f"{payload_issue_residency_update_prefix}_decision": "blocked",
            f"{payload_issue_residency_update_prefix}_block_reason": (
                "payload_transfer_disabled"
            ),
            f"{payload_issue_residency_update_prefix}_execution_mode": (
                "payload_cache_live_runtime_adapter_"
    ...
    for key in (
        ...
        summary[f"{payload_issue_residency_update_prefix}_{key}"] = False
    payload_issue_payload_deref_prefix = (
        "prefetch_lab_default_stream_queue_budget_"
        "live_runtime_adapter_payload_issue_payload_deref_blocked_canary"
    )
    payload_issue_residency_update_status = str(
        summary[f"{payload_issue_residency_update_prefix}_status"],
    )
    summary.update(
        {
            f"{payload_issue_payload_deref_prefix}_present": True,
            f"{payload_issue_payload_deref_prefix}_stage": (
                "payload_cache_live_runtime_adapter_payload_issue_payload_deref_blocked_canary"
            ),
            f"{payload_issue_payload_deref_prefix}_status": (
                "blocked_by_payload_issue_residency_update_blocked_canary:"
                f"{payload_issue_residency_update_status}"
            ),
            f"{payload_issue_payload_deref_prefix}_consumes_payload_issue_residency_update_blocked_canary": True,
            f"{payload_issue_payload_deref_prefix}_payload_issue_residency_update_status": (
                payload_issue_residency_update_status
            ),
            f"{payload_issue_payload_deref_prefix}_payload_issue_payload_deref_schema": (
                "payload_cache_runtime_payload_issue_payload_deref_v1"
            ),
            f"{payload_issue_payload_deref_prefix}_payload_issue_payload_deref_canary_created": True,
            f"{payload_issue_payload_deref_prefix}_payload_issue_residency_update_consumed": True,
            f"{payload_issue_payload_deref_prefix}_payload_deref_checked": True,
            f"{payload_issue_payload_deref_prefix}_payload_deref_rejected": True,
            f"{payload_issue_payload_deref_prefix}_payload_deref_allowed_for_resident_payload": False,
            f"{payload_issue_payload_deref_prefix}_payload_deref_attempted": False,
            f"{payload_issue_payload_deref_prefix}_payload_handle_deref_checked": True,
            f"{payload_issue_payload_deref_prefix}_payload_handle_deref_rejected": True,
            f"{payload_issue_payload_deref_prefix}_payload_handle_deref_attempted": False,
            f"{payload_issue_payload_deref_prefix}_payload_marked_resident": False,
            f"{payload_issue_payload_deref_prefix}_resident_payload_ready": False,
            f"{payload_issue_payload_deref_prefix}_ready_credit_granted": False,
            f"{payload_issue_payload_deref_prefix}_ready_before_demand_credit_granted": False,
            f"{payload_issue_payload_deref_prefix}_real_payload_ready": False,
            f"{payload_issue_payload_deref_prefix}_copy_completed": False,
            f"{payload_issue_payload_deref_prefix}_request_source": summary[
                f"{payload_issue_residency_update_prefix}_request_source"
            ],
            f"{payload_issue_payload_deref_prefix}_request_layer_idx": summary[
                f"{payload_issue_residency_update_prefix}_request_layer_idx"
            ],
            f"{payload_issue_payload_deref_prefix}_request_expert_idx": summary[
                f"{payload_issue_residency_update_prefix}_request_expert_idx"
            ],
            f"{payload_issue_payload_deref_prefix}_requested_payload_bytes": summary[
                f"{payload_issue_residency_update_prefix}_requested_payload_bytes"
            ],
            f"{payload_issue_payload_deref_prefix}_source_issue_packet_count": summary[
                f"{payload_issue_residency_update_prefix}_source_issue_packet_count"
            ],
            f"{payload_issue_payload_deref_prefix}_source_issue_unique_key_count": summary[
                f"{payload_issue_residency_update_prefix}_source_issue_unique_key_count"
            ],
            f"{payload_issue_payload_deref_prefix}_source_queue_budget_capacity": summary[
                f"{payload_issue_residency_update_prefix}_source_queue_budget_capacity"
            ],
            f"{payload_issue_payload_deref_prefix}_source_issue_lead_tokens": summary[
                f"{payload_issue_residency_update_prefix}_source_issue_lead_tokens"
            ],
            f"{payload_issue_payload_deref_prefix}_source_queue_deadline_us": summary[
                f"{payload_issue_residency_update_prefix}_source_queue_deadline_us"
            ],
            f"{payload_issue_payload_deref_prefix}_planned_issue_count": 0,
            f"{payload_issue_payload_deref_prefix}_scheduled_issue_count": 0,
            f"{payload_issue_payload_deref_prefix}_queued_issue_count": 0,
            f"{payload_issue_payload_deref_prefix}_submitted_issue_count": 0,
            f"{payload_issue_payload_deref_prefix}_inflight_issue_count": 0,
            f"{payload_issue_payload_deref_prefix}_dispatched_issue_count": 0,
            f"{payload_issue_payload_deref_prefix}_command_packet_count": 0,
            f"{payload_issue_payload_deref_prefix}_transport_work_count": 0,
            f"{payload_issue_payload_deref_prefix}_transport_worker_dispatch_count": 0,
            f"{payload_issue_payload_deref_prefix}_copy_descriptor_count": 0,
            f"{payload_issue_payload_deref_prefix}_copy_completion_count": 0,
            f"{payload_issue_payload_deref_prefix}_ready_credit_count": 0,
            f"{payload_issue_payload_deref_prefix}_residency_update_count": 0,
            f"{payload_issue_payload_deref_prefix}_resident_payload_count": 0,
            f"{payload_issue_payload_deref_prefix}_payload_handle_deref_count": 0,
            f"{payload_issue_payload_deref_prefix}_issued_payload_count": 0,
            f"{payload_issue_payload_deref_prefix}_payload_bytes": 0,
            f"{payload_issue_payload_deref_prefix}_resident_payload_bytes": 0,
            f"{payload_issue_payload_deref_prefix}_dereferenced_payload_bytes": 0,
            f"{payload_issue_payload_deref_prefix}_decision": "blocked",
            f"{payload_issue_payload_deref_prefix}_block_reason": (
                "payload_transfer_disabled"
            ),
            f"{payload_issue_payload_deref_prefix}_execution_mode": (
                "payload_cache_live_runtime_adapter_"
...
def test_check_premap_lab_preflight_summary_rejects_missing_payload_consumer_visible_hit_label() -> None:
    summary = _summary()
    summary["required_evidence"]["evidence"].pop(
        "payload_cache_consumer_visible_hit_blocked_gate_json"
    )
...
def test_check_premap_lab_preflight_summary_rejects_payloadless_useful_repeat_incomplete_useful_work() -> None:
    summary = _summary()
    summary[
        "default_kernel_consumer_wna16_side_variant_online_source_identity_subset"
    ] = True
    ...
    summary[f"{prefix}_useful_work_units"] = (
        int(summary[f"{prefix}_row_count"]) * (len(PAYLOADLESS_USEFUL_FIELDS) - 1)
    )
    ...
    assert f"{prefix}_useful_work_units_mismatch" in result["failures"]
...
def test_check_premap_lab_preflight_summary_rejects_payload_issue_copy_descriptor_dispatch_escape() -> None:
    summary = _summary()
    prefix = (
        "prefetch_lab_default_stream_queue_budget_"
        "live_runtime_adapter_payload_issue_copy_descriptor_dispatch_blocked_canary"
    ...
    summary[f"{prefix}_status"] = "passed"
    summary[f"{prefix}_consumes_payload_issue_copy_descriptor_submit_blocked_canary"] = False
    summary[f"{prefix}_payload_issue_copy_descriptor_submit_status"] = "stale"
    summary[f"{prefix}_payload_issue_copy_descriptor_dispatch_schema"] = "dispatch_v0"
    summary[f"{prefix}_payload_issue_copy_descriptor_dispatch_canary_created"] = False
    summary[f"{prefix}_payload_issue_copy_descriptor_submit_consumed"] = False
    summary[f"{prefix}_copy_descriptor_dispatch_checked"] = False
    summary[f"{prefix}_copy_descriptor_dispatch_rejected"] = False
    summary[f"{prefix}_copy_descriptor_dispatch_allowed"] = True
    summary[f"{prefix}_copy_descriptor_dispatched"] = True
    summary[f"{prefix}_copy_descriptor_submitted"] = True
    summary[f"{prefix}_copy_descriptor_executed"] = True
    summary[f"{prefix}_request_source"] = "synthetic_payload_issue_request"
    summary[f"{prefix}_request_layer_idx"] = 1
    ...
    summary[f"{prefix}_decision"] = "allow"
    summary[f"{prefix}_block_reason"] = "payload_transfer_enabled"
    summary[f"{prefix}_execution_mode"] = "payload_issue_copy_descriptor_dispatch_live"
    summary[f"{prefix}_live_payload_runtime_enabled"] = True
    summary[f"{prefix}_payload_transfer_runtime_enabled"] = True
    summary[f"{prefix}_payload_deref_allowed"] = True
    summary[f"{prefix}_payload_deref_runtime_allowed"] = True
    ...
    assert f"{prefix}_status_mismatch" in result["failures"]
    assert (
        f"{prefix}_consumes_payload_issue_copy_descriptor_submit_blocked_canary_mismatch"
        in result["failures"]
    )
    assert (
        f"{prefix}_payload_issue_copy_descriptor_submit_status_mismatch"
        in result["failures"]
    )
    assert (
        f"{prefix}_payload_issue_copy_descriptor_dispatch_schema_mismatch"
        in result["failures"]
    )
    assert (
        f"{prefix}_payload_issue_copy_descriptor_dispatch_canary_created_mismatch"
        in result["failures"]
    )
    assert (
        f"{prefix}_payload_issue_copy_descriptor_submit_consumed_mismatch"
        in result["failures"]
    )
    assert f"{prefix}_copy_descriptor_dispatch_checked_mismatch" in result["failures"]
    assert f"{prefix}_copy_descriptor_dispatch_rejected_mismatch" in result["failures"]
    assert f"{prefix}_copy_descriptor_dispatch_allowed_mismatch" in result["failures"]
    assert f"{prefix}_copy_descriptor_dispatched_mismatch" in result["failures"]
    assert f"{prefix}_copy_descriptor_submitted_mismatch" in result["failures"]
    assert f"{prefix}_copy_descriptor_executed_mismatch" in result["failures"]
    assert f"{prefix}_request_source_mismatch" in result["failures"]
    assert f"{prefix}_request_layer_idx_mismatch" in result["failures"]
...
def test_check_premap_lab_preflight_summary_rejects_payload_issue_copy_descriptor_execution_escape() -> None:
    summary = _summary()
    prefix = (
        "prefetch_lab_default_stream_queue_budget_"
        "live_runtime_adapter_payload_issue_copy_descriptor_execution_blocked_canary"
    ...
    summary[f"{prefix}_status"] = "passed"
    summary[f"{prefix}_consumes_payload_issue_copy_descriptor_dispatch_blocked_canary"] = False
    summary[f"{prefix}_payload_issue_copy_descriptor_dispatch_status"] = "stale"
    summary[f"{prefix}_payload_issue_copy_descriptor_execution_schema"] = "execution_v0"
    summary[f"{prefix}_payload_issue_copy_descriptor_execution_canary_created"] = False
    summary[f"{prefix}_payload_issue_copy_descriptor_dispatch_consumed"] = False
    summary[f"{prefix}_copy_descriptor_execution_checked"] = False
    summary[f"{prefix}_copy_descriptor_execution_rejected"] = False
    summary[f"{prefix}_copy_descriptor_execution_allowed"] = True
    summary[f"{prefix}_copy_descriptor_dispatched"] = True
    summary[f"{prefix}_copy_descriptor_submitted"] = True
    summary[f"{prefix}_copy_descriptor_executed"] = True
    summary[f"{prefix}_request_source"] = "synthetic_payload_issue_request"
    ...
    summary[f"{prefix}_decision"] = "allow"
    summary[f"{prefix}_block_reason"] = "payload_transfer_enabled"
    summary[f"{prefix}_execution_mode"] = "payload_issue_copy_descriptor_execution_live"
    summary[f"{prefix}_live_payload_runtime_enabled"] = True
    summary[f"{prefix}_payload_transfer_runtime_enabled"] = True
    summary[f"{prefix}_payload_deref_allowed"] = True
    summary[f"{prefix}_payload_deref_runtime_allowed"] = True
    ...
    assert f"{prefix}_status_mismatch" in result["failures"]
    assert (
        f"{prefix}_consumes_payload_issue_copy_descriptor_dispatch_blocked_canary_mismatch"
        in result["failures"]
    )
    assert (
        f"{prefix}_payload_issue_copy_descriptor_dispatch_status_mismatch"
        in result["failures"]
    )
    assert (
        f"{prefix}_payload_issue_copy_descriptor_execution_schema_mismatch"
        in result["failures"]
    )
    assert (
        f"{prefix}_payload_issue_copy_descriptor_execution_canary_created_mismatch"
        in result["failures"]
    )
    assert (
        f"{prefix}_payload_issue_copy_descriptor_dispatch_consumed_mismatch"
        in result["failures"]
    )
    assert f"{prefix}_copy_descriptor_execution_checked_mismatch" in result["failures"]
    assert f"{prefix}_copy_descriptor_execution_rejected_mismatch" in result["failures"]
    assert f"{prefix}_copy_descriptor_execution_allowed_mismatch" in result["failures"]
    assert f"{prefix}_copy_descriptor_dispatched_mismatch" in result["failures"]
    assert f"{prefix}_copy_descriptor_submitted_mismatch" in result["failures"]
    assert f"{prefix}_copy_descriptor_executed_mismatch" in result["failures"]
    assert f"{prefix}_request_source_mismatch" in result["failures"]
...
def test_check_premap_lab_preflight_summary_rejects_payload_issue_copy_completion_escape() -> None:
    summary = _summary()
    prefix = (
        "prefetch_lab_default_stream_queue_budget_"
        "live_runtime_adapter_payload_issue_copy_completion_blocked_canary"
    ...
    summary[f"{prefix}_status"] = "passed"
    summary[f"{prefix}_consumes_payload_issue_copy_descriptor_execution_blocked_canary"] = False
    summary[f"{prefix}_payload_issue_copy_descriptor_execution_status"] = "stale"
    summary[f"{prefix}_payload_issue_copy_completion_schema"] = "completion_v0"
    summary[f"{prefix}_payload_issue_copy_completion_canary_created"] = False
    summary[f"{prefix}_payload_issue_copy_descriptor_execution_consumed"] = False
    summary[f"{prefix}_copy_completion_checked"] = False
    summary[f"{prefix}_copy_completion_rejected"] = False
    summary[f"{prefix}_copy_completion_allowed"] = True
    summary[f"{prefix}_copy_completed"] = True
    summary[f"{prefix}_copy_descriptor_dispatched"] = True
    summary[f"{prefix}_copy_descriptor_submitted"] = True
    summary[f"{prefix}_copy_descriptor_executed"] = True
    summary[f"{prefix}_request_source"] = "synthetic_payload_issue_request"
    ...
    summary[f"{prefix}_transport_worker_dispatch_count"] = 1
    summary[f"{prefix}_copy_descriptor_count"] = 1
    summary[f"{prefix}_copy_completion_count"] = 1
    summary[f"{prefix}_issued_payload_count"] = 1
    summary[f"{prefix}_payload_bytes"] = 64
    summary[f"{prefix}_decision"] = "allow"
    summary[f"{prefix}_block_reason"] = "payload_transfer_enabled"
    summary[f"{prefix}_execution_mode"] = "payload_issue_copy_completion_live"
    summary[f"{prefix}_live_payload_runtime_enabled"] = True
    summary[f"{prefix}_payload_transfer_runtime_enabled"] = True
    summary[f"{prefix}_payload_deref_allowed"] = True
    summary[f"{prefix}_payload_deref_runtime_allowed"] = True
    ...
    assert f"{prefix}_status_mismatch" in result["failures"]
    assert (
        f"{prefix}_consumes_payload_issue_copy_descriptor_execution_blocked_canary_mismatch"
        in result["failures"]
    )
    assert (
        f"{prefix}_payload_issue_copy_descriptor_execution_status_mismatch"
        in result["failures"]
    )
    assert f"{prefix}_payload_issue_copy_completion_schema_mismatch" in result["failures"]
    assert (
        f"{prefix}_payload_issue_copy_completion_canary_created_mismatch"
        in result["failures"]
    )
    assert (
        f"{prefix}_payload_issue_copy_descriptor_execution_consumed_mismatch"
        in result["failures"]
    )
    assert f"{prefix}_copy_completion_checked_mismatch" in result["failures"]
    assert f"{prefix}_copy_completion_rejected_mismatch" in result["failures"]
    assert f"{prefix}_copy_completion_allowed_mismatch" in result["failures"]
    assert f"{prefix}_copy_completed_mismatch" in result["failures"]
    assert f"{prefix}_copy_descriptor_dispatched_mismatch" in result["failures"]
    assert f"{prefix}_copy_descriptor_submitted_mismatch" in result["failures"]
    assert f"{prefix}_copy_descriptor_executed_mismatch" in result["failures"]
    assert f"{prefix}_request_source_mismatch" in result["failures"]
    ...
    assert f"{prefix}_transport_worker_dispatch_count_mismatch" in result["failures"]
    assert f"{prefix}_copy_descriptor_count_mismatch" in result["failures"]
    assert f"{prefix}_copy_completion_count_mismatch" in result["failures"]
    assert f"{prefix}_issued_payload_count_mismatch" in result["failures"]
    assert f"{prefix}_payload_bytes_mismatch" in result["failures"]
    assert f"{prefix}_decision_mismatch" in result["failures"]
    assert f"{prefix}_block_reason_mismatch" in result["failures"]
...
def test_check_premap_lab_preflight_summary_rejects_payload_issue_ready_credit_escape() -> None:
    summary = _summary()
    prefix = (
        "prefetch_lab_default_stream_queue_budget_"
        "live_runtime_adapter_payload_issue_ready_credit_blocked_canary"
    ...
    summary[f"{prefix}_status"] = "passed"
    summary[f"{prefix}_consumes_payload_issue_copy_completion_blocked_canary"] = False
    summary[f"{prefix}_payload_issue_copy_completion_status"] = "stale"
    summary[f"{prefix}_payload_issue_ready_credit_schema"] = "ready_credit_v0"
    summary[f"{prefix}_payload_issue_ready_credit_canary_created"] = False
    summary[f"{prefix}_payload_issue_copy_completion_consumed"] = False
    summary[f"{prefix}_ready_credit_checked"] = False
    summary[f"{prefix}_ready_credit_rejected"] = False
    summary[f"{prefix}_ready_credit_allowed"] = True
    summary[f"{prefix}_ready_credit_granted"] = True
    summary[f"{prefix}_ready_before_demand_credit_granted"] = True
    summary[f"{prefix}_real_payload_ready"] = True
    summary[f"{prefix}_copy_completed"] = True
    summary[f"{prefix}_copy_descriptor_dispatched"] = True
    summary[f"{prefix}_copy_descriptor_submitted"] = True
    summary[f"{prefix}_copy_descriptor_executed"] = True
    ...
    summary[f"{prefix}_copy_descriptor_count"] = 1
    summary[f"{prefix}_copy_completion_count"] = 1
    summary[f"{prefix}_ready_credit_count"] = 1
    summary[f"{prefix}_issued_payload_count"] = 1
    summary[f"{prefix}_payload_bytes"] = 64
    summary[f"{prefix}_decision"] = "allow"
    summary[f"{prefix}_block_reason"] = "payload_transfer_enabled"
    summary[f"{prefix}_execution_mode"] = "payload_issue_ready_credit_live"
    summary[f"{prefix}_live_payload_runtime_enabled"] = True
    summary[f"{prefix}_payload_transfer_runtime_enabled"] = True
    summary[f"{prefix}_payload_deref_allowed"] = True
    summary[f"{prefix}_payload_deref_runtime_allowed"] = True
    ...
    assert f"{prefix}_status_mismatch" in result["failures"]
    assert (
        f"{prefix}_consumes_payload_issue_copy_completion_blocked_canary_mismatch"
        in result["failures"]
    )
    assert f"{prefix}_payload_issue_copy_completion_status_mismatch" in result["failures"]
    assert f"{prefix}_payload_issue_ready_credit_schema_mismatch" in result["failures"]
    assert f"{prefix}_payload_issue_ready_credit_canary_created_mismatch" in result["failures"]
    assert f"{prefix}_payload_issue_copy_completion_consumed_mismatch" in result["failures"]
    assert f"{prefix}_ready_credit_checked_mismatch" in result["failures"]
    assert f"{prefix}_ready_credit_rejected_mismatch" in result["failures"]
    assert f"{prefix}_ready_credit_allowed_mismatch" in result["failures"]
    assert f"{prefix}_ready_credit_granted_mismatch" in result["failures"]
    assert f"{prefix}_ready_before_demand_credit_granted_mismatch" in result["failures"]
    assert f"{prefix}_real_payload_ready_mismatch" in result["failures"]
    assert f"{prefix}_copy_completed_mismatch" in result["failures"]
    assert f"{prefix}_copy_descriptor_dispatched_mismatch" in result["failures"]
    assert f"{prefix}_copy_descriptor_submitted_mismatch" in result["failures"]
    assert f"{prefix}_copy_descriptor_executed_mismatch" in result["failures"]
    ...
    assert f"{prefix}_copy_descriptor_count_mismatch" in result["failures"]
    assert f"{prefix}_copy_completion_count_mismatch" in result["failures"]
    assert f"{prefix}_ready_credit_count_mismatch" in result["failures"]
    assert f"{prefix}_issued_payload_count_mismatch" in result["failures"]
    assert f"{prefix}_payload_bytes_mismatch" in result["failures"]
    assert f"{prefix}_decision_mismatch" in result["failures"]
    assert f"{prefix}_block_reason_mismatch" in result["failures"]
...
def test_check_premap_lab_preflight_summary_rejects_payload_issue_residency_update_escape() -> None:
    summary = _summary()
    prefix = (
        "prefetch_lab_default_stream_queue_budget_"
        "live_runtime_adapter_payload_issue_residency_update_blocked_canary"
    ...
    summary[f"{prefix}_status"] = "passed"
    summary[f"{prefix}_consumes_payload_issue_ready_credit_blocked_canary"] = False
    summary[f"{prefix}_payload_issue_ready_credit_status"] = "stale"
    summary[f"{prefix}_payload_issue_residency_update_schema"] = "residency_v0"
    summary[f"{prefix}_payload_issue_residency_update_canary_created"] = False
    summary[f"{prefix}_payload_issue_ready_credit_consumed"] = False
    summary[f"{prefix}_residency_update_checked"] = False
    summary[f"{prefix}_residency_update_rejected"] = False
    summary[f"{prefix}_residency_update_allowed"] = True
    summary[f"{prefix}_residency_updated"] = True
    summary[f"{prefix}_payload_marked_resident"] = True
    summary[f"{prefix}_resident_payload_ready"] = True
    summary[f"{prefix}_ready_credit_granted"] = True
    summary[f"{prefix}_ready_before_demand_credit_granted"] = True
    summary[f"{prefix}_real_payload_ready"] = True
    summary[f"{prefix}_copy_completed"] = True
    ...
    summary[f"{prefix}_copy_completion_count"] = 1
    summary[f"{prefix}_ready_credit_count"] = 1
    summary[f"{prefix}_residency_update_count"] = 1
    summary[f"{prefix}_resident_payload_count"] = 1
    summary[f"{prefix}_issued_payload_count"] = 1
    summary[f"{prefix}_payload_bytes"] = 64
    summary[f"{prefix}_resident_payload_bytes"] = 64
    summary[f"{prefix}_decision"] = "allow"
    summary[f"{prefix}_block_reason"] = "payload_transfer_enabled"
    summary[f"{prefix}_execution_mode"] = "payload_issue_residency_update_live"
    summary[f"{prefix}_live_payload_runtime_enabled"] = True
    summary[f"{prefix}_payload_transfer_runtime_enabled"] = True
    summary[f"{prefix}_payload_deref_allowed"] = True
    summary[f"{prefix}_payload_deref_runtime_allowed"] = True
    ...
    assert f"{prefix}_status_mismatch" in result["failures"]
    assert (
        f"{prefix}_consumes_payload_issue_ready_credit_blocked_canary_mismatch"
        in result["failures"]
    )
    assert f"{prefix}_payload_issue_ready_credit_status_mismatch" in result["failures"]
    assert f"{prefix}_payload_issue_residency_update_schema_mismatch" in result["failures"]
    assert (
        f"{prefix}_payload_issue_residency_update_canary_created_mismatch"
        in result["failures"]
    )
    assert f"{prefix}_payload_issue_ready_credit_consumed_mismatch" in result["failures"]
    assert f"{prefix}_residency_update_checked_mismatch" in result["failures"]
    assert f"{prefix}_residency_update_rejected_mismatch" in result["failures"]
    assert f"{prefix}_residency_update_allowed_mismatch" in result["failures"]
    assert f"{prefix}_residency_updated_mismatch" in result["failures"]
    assert f"{prefix}_payload_marked_resident_mismatch" in result["failures"]
    assert f"{prefix}_resident_payload_ready_mismatch" in result["failures"]
    assert f"{prefix}_ready_credit_granted_mismatch" in result["failures"]
    assert f"{prefix}_ready_before_demand_credit_granted_mismatch" in result["failures"]
    assert f"{prefix}_real_payload_ready_mismatch" in result["failures"]
    assert f"{prefix}_copy_completed_mismatch" in result["failures"]
    ...
    assert f"{prefix}_copy_completion_count_mismatch" in result["failures"]
    assert f"{prefix}_ready_credit_count_mismatch" in result["failures"]
    assert f"{prefix}_residency_update_count_mismatch" in result["failures"]
    assert f"{prefix}_resident_payload_count_mismatch" in result["failures"]
    assert f"{prefix}_issued_payload_count_mismatch" in result["failures"]
    assert f"{prefix}_payload_bytes_mismatch" in result["failures"]
    assert f"{prefix}_resident_payload_bytes_mismatch" in result["failures"]
    assert f"{prefix}_decision_mismatch" in result["failures"]
    assert f"{prefix}_block_reason_mismatch" in result["failures"]
    assert f"{prefix}_execution_mode_mismatch" in result["failures"]
    assert f"{prefix}_live_payload_runtime_enabled_mismatch" in result["failures"]
...
def test_check_premap_lab_preflight_summary_rejects_payload_issue_payload_deref_escape() -> None:
    summary = _summary()
    prefix = (
        "prefetch_lab_default_stream_queue_budget_"
        "live_runtime_adapter_payload_issue_payload_deref_blocked_canary"
    ...
    summary[f"{prefix}_status"] = "passed"
    summary[f"{prefix}_consumes_payload_issue_residency_update_blocked_canary"] = False
    summary[f"{prefix}_payload_issue_residency_update_status"] = "stale"
    summary[f"{prefix}_payload_issue_payload_deref_schema"] = "payload_deref_v0"
    summary[f"{prefix}_payload_issue_payload_deref_canary_created"] = False
    summary[f"{prefix}_payload_issue_residency_update_consumed"] = False
    summary[f"{prefix}_payload_deref_checked"] = False
    summary[f"{prefix}_payload_deref_rejected"] = False
    summary[f"{prefix}_payload_deref_allowed_for_resident_payload"] = True
    summary[f"{prefix}_payload_deref_attempted"] = True
    summary[f"{prefix}_payload_handle_deref_checked"] = False
    summary[f"{prefix}_payload_handle_deref_rejected"] = False
    summary[f"{prefix}_payload_handle_deref_attempted"] = True
    summary[f"{prefix}_payload_marked_resident"] = True
    summary[f"{prefix}_resident_payload_ready"] = True
    summary[f"{prefix}_ready_credit_granted"] = True
    summary[f"{prefix}_ready_before_demand_credit_granted"] = True
    ...
    summary[f"{prefix}_residency_update_count"] = 1
    summary[f"{prefix}_resident_payload_count"] = 1
    summary[f"{prefix}_payload_handle_deref_count"] = 1
    summary[f"{prefix}_issued_payload_count"] = 1
    summary[f"{prefix}_payload_bytes"] = 64
    summary[f"{prefix}_resident_payload_bytes"] = 64
    summary[f"{prefix}_dereferenced_payload_bytes"] = 64
    summary[f"{prefix}_decision"] = "allow"
    summary[f"{prefix}_block_reason"] = "payload_transfer_enabled"
    summary[f"{prefix}_execution_mode"] = "payload_issue_payload_deref_live"
    summary[f"{prefix}_live_payload_runtime_enabled"] = True
    summary[f"{prefix}_payload_transfer_runtime_enabled"] = True
    summary[f"{prefix}_payload_deref_allowed"] = True
    summary[f"{prefix}_payload_deref_runtime_allowed"] = True
    ...
    assert f"{prefix}_status_mismatch" in result["failures"]
    assert (
        f"{prefix}_consumes_payload_issue_residency_update_blocked_canary_mismatch"
        in result["failures"]
    )
    assert f"{prefix}_payload_issue_residency_update_status_mismatch" in result["failures"]
    assert f"{prefix}_payload_issue_payload_deref_schema_mismatch" in result["failures"]
    assert f"{prefix}_payload_issue_payload_deref_canary_created_mismatch" in result["failures"]
    assert f"{prefix}_payload_issue_residency_update_consumed_mismatch" in result["failures"]
    assert f"{prefix}_payload_deref_checked_mismatch" in result["failures"]
    assert f"{prefix}_payload_deref_rejected_mismatch" in result["failures"]
    assert f"{prefix}_payload_deref_allowed_for_resident_payload_mismatch" in result["failures"]
    assert f"{prefix}_payload_deref_attempted_mismatch" in result["failures"]
    assert f"{prefix}_payload_handle_deref_checked_mismatch" in result["failures"]
    assert f"{prefix}_payload_handle_deref_rejected_mismatch" in result["failures"]
    assert f"{prefix}_payload_handle_deref_attempted_mismatch" in result["failures"]
    assert f"{prefix}_payload_marked_resident_mismatch" in result["failures"]
    assert f"{prefix}_resident_payload_ready_mismatch" in result["failures"]
    assert f"{prefix}_ready_credit_granted_mismatch" in result["failures"]
    assert f"{prefix}_ready_before_demand_credit_granted_mismatch" in result["failures"]
    ...
    assert f"{prefix}_residency_update_count_mismatch" in result["failures"]
    assert f"{prefix}_resident_payload_count_mismatch" in result["failures"]
    assert f"{prefix}_payload_handle_deref_count_mismatch" in result["failures"]
    assert f"{prefix}_issued_payload_count_mismatch" in result["failures"]
    assert f"{prefix}_payload_bytes_mismatch" in result["failures"]
    assert f"{prefix}_resident_payload_bytes_mismatch" in result["failures"]
    assert f"{prefix}_dereferenced_payload_bytes_mismatch" in result["failures"]
    assert f"{prefix}_decision_mismatch" in result["failures"]
    assert f"{prefix}_block_reason_mismatch" in result["failures"]
    assert f"{prefix}_execution_mode_mismatch" in result["failures"]
    assert f"{prefix}_live_payload_runtime_enabled_mismatch" in result["failures"]
