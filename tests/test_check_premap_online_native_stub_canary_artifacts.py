    ...
    def future_native_request_ptr_summary() -> dict:
        ...
        return {
            **stub_summary(),
            ...
            "future_kernel_native_consumer_request_ptr_single_field_handoff_checked": True,
            "future_kernel_native_consumer_request_ptr_single_field_handoff_field_name": "scale_metadata_handle",
            "future_kernel_native_consumer_request_ptr_single_field_handoff_source": "native_request_summary_field_read_counts",
            "future_kernel_native_consumer_request_ptr_single_field_handoff_row_count": row_count,
            "future_kernel_native_consumer_request_ptr_single_field_handoff_row_ok_count": row_count,
            "future_kernel_native_consumer_request_ptr_single_field_handoff_error_count": 0,
            "future_kernel_native_consumer_request_ptr_single_field_handoff_hash_accumulator": field_read_hash,
            "future_kernel_native_consumer_request_ptr_single_field_handoff_payload_bytes": 0,
            "future_kernel_native_consumer_request_ptr_single_field_handoff_passed_to_kernel": False,
            "future_kernel_native_consumer_request_ptr_single_field_handoff_changes_kernel_launch_args": False,
            "future_kernel_native_consumer_request_ptr_single_field_handoff_current_wna16_arg_compatible": False,
            "future_kernel_native_consumer_request_ptr_single_field_handoff_requires_wna16_arg_reinterpretation": False,
...
def _payloads(root: Path) -> tuple[Path, Path, Path]:
    ...
    def future_native_request_ptr_summary() -> dict[str, object]:
        ...
        return {
            ...
            "future_kernel_native_consumer_request_ptr_single_field_handoff_field_name": "scale_metadata_handle",
            "future_kernel_native_consumer_request_ptr_single_field_handoff_source": "native_request_summary_field_read_counts",
            "future_kernel_native_consumer_request_ptr_single_field_handoff_row_count": 4,
            "future_kernel_native_consumer_request_ptr_single_field_handoff_row_ok_count": 4,
            "future_kernel_native_consumer_request_ptr_single_field_handoff_error_count": 0,
            "future_kernel_native_consumer_request_ptr_single_field_handoff_hash_accumulator": field_read_hash,
            "future_kernel_native_consumer_request_ptr_single_field_handoff_payload_bytes": 0,
            "future_kernel_native_consumer_request_ptr_single_field_handoff_passed_to_kernel": False,
