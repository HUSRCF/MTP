...
def _add_kernel_arg_semantic_handle_adapter(summary: dict) -> dict:
    aggregate = summary["aggregate"]
    checked_count = int(
        aggregate[
            "premap_consumer_descriptor_prep_consumer_shim_executed_count"
    ...
    aggregate.update(
        {
            "premap_consumer_descriptor_prep_consumer_shim_kernel_arg_semantic_handle_adapter_checked_count": checked_count,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_arg_semantic_handle_adapter_ready_count": checked_count,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_arg_semantic_handle_adapter_hash_checked_count": checked_count,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_arg_semantic_handle_adapter_hash_missing_count": 0,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_arg_semantic_handle_adapter_table_object_hash_checked_count": checked_count,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_arg_semantic_handle_adapter_table_object_hash_missing_count": 0,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_arg_semantic_handle_adapter_launch_schema_mirror_hash_checked_count": checked_count,
            ...
            "premap_consumer_descriptor_prep_consumer_shim_kernel_arg_semantic_handle_adapter_mode": "readonly_kernel_arg_semantic_handle_adapter",
            "premap_consumer_descriptor_prep_consumer_shim_kernel_arg_semantic_handle_adapter_mode_checked_count": checked_count,
            ...
            "premap_consumer_descriptor_prep_consumer_shim_kernel_arg_semantic_handle_adapter_row_count": row_count,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_arg_semantic_handle_adapter_column_count_max": 4,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_arg_semantic_handle_adapter_column_count_min": 4,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_arg_semantic_handle_adapter_table_schema_hash": (
                PREMAP_DESCRIPTOR_CONSUMER_HANDLE_TABLE_SCHEMA_HASH
            ),
            "premap_consumer_descriptor_prep_consumer_shim_kernel_arg_semantic_handle_adapter_table_schema_hash_checked_count": checked_count,
            ...
            "premap_consumer_descriptor_prep_consumer_shim_kernel_arg_semantic_handle_adapter_semantic_schema_name_checked_count": checked_count,
            ...
            "premap_consumer_descriptor_prep_consumer_shim_kernel_arg_semantic_handle_adapter_semantic_schema_hash_checked_count": checked_count,
            ...
            "premap_consumer_descriptor_prep_consumer_shim_kernel_arg_semantic_handle_adapter_semantic_field_count": (
                checked_count * len(PREMAP_KERNEL_ARG_SEMANTIC_HANDLE_SCHEMA_FIELDS)
            ),
            "premap_consumer_descriptor_prep_consumer_shim_kernel_arg_semantic_handle_adapter_required_source_hit_count": row_count * 3,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_arg_semantic_handle_adapter_required_source_miss_count": 0,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_arg_semantic_handle_adapter_optional_source_hit_count": row_count,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_arg_semantic_handle_adapter_optional_source_miss_count": 0,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_arg_semantic_handle_adapter_handle_field_read_count": row_count * 4,
    ...
    aggregate.update(
        {
            ...
            "premap_consumer_descriptor_prep_consumer_shim_single_field_handle_handoff_canary_mirror_handle_hash_checked_count": checked_count,
            "premap_consumer_descriptor_prep_consumer_shim_single_field_handle_handoff_canary_mirror_handle_hash_missing_count": 0,
            "premap_consumer_descriptor_prep_consumer_shim_single_field_handle_handoff_canary_mirror_schema_hash_checked_count": checked_count,
            "premap_consumer_descriptor_prep_consumer_shim_single_field_handle_handoff_canary_mirror_schema_hash_missing_count": 0,
            ...
            "premap_consumer_descriptor_prep_consumer_shim_single_field_handle_handoff_canary_mirror_source": "semantic_handle_table",
            "premap_consumer_descriptor_prep_consumer_shim_single_field_handle_handoff_canary_mirror_source_checked_count": checked_count,
            "premap_consumer_descriptor_prep_consumer_shim_single_field_handle_handoff_canary_mirror_source_missing_count": 0,
            "premap_consumer_descriptor_prep_consumer_shim_single_field_handle_handoff_canary_mirror_source_mismatch_count": 0,
            ...
            "premap_consumer_descriptor_prep_consumer_shim_single_field_handle_handoff_canary_kernel_side_typed_consumer_compatible_count": checked_count,
            "premap_consumer_descriptor_prep_consumer_shim_single_field_handle_handoff_canary_current_wna16_arg_compatible_count": 0,
        }
    )
    return summary
...
def _add_kernel_side_consumer_schema_adapter(
    ...
    *,
    ...
    aggregate.update(
        {
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_checked_count": checked_count,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_ready_count": checked_count,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_hash_checked_count": checked_count,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_hash_missing_count": 0,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_semantic_adapter_hash_checked_count": checked_count,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_semantic_adapter_hash_missing_count": 0,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_table_object_hash_checked_count": checked_count,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_table_object_hash_missing_count": 0,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_launch_schema_mirror_hash_checked_count": checked_count,
            ...
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_mode": "readonly_kernel_side_consumer_schema_adapter",
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_mode_checked_count": checked_count,
            ...
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_row_count": row_count,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_column_count_max": 4,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_column_count_min": 4,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_table_schema_hash": (
                PREMAP_DESCRIPTOR_CONSUMER_HANDLE_TABLE_SCHEMA_HASH
            ),
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_table_schema_hash_checked_count": checked_count,
            ...
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_semantic_schema_hash_checked_count": checked_count,
            ...
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_kernel_side_schema_name_checked_count": checked_count,
            ...
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_kernel_side_schema_hash_checked_count": checked_count,
            ...
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_kernel_side_field_count": (
                checked_count * len(PREMAP_KERNEL_SIDE_CONSUMER_SCHEMA_FIELDS)
            ),
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_required_source_hit_count": row_count * 3,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_required_source_miss_count": 0,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_optional_source_hit_count": row_count,
...
def _add_kernel_side_typed_consumer_object(
    summary: dict,
    *,
    consumer_connected: bool = False,
    live_enabled: bool = False,
    live_eligible: bool = False,
    block_reason: str = "kernel_side_typed_consumer_live_disabled",
) -> dict:
    aggregate = summary["aggregate"]
    checked_count = int(
        aggregate[
    ...
    aggregate.update(
        {
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_checked_count": checked_count,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_ready_count": checked_count,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_hash_checked_count": checked_count,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_hash_missing_count": 0,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_kernel_side_adapter_hash_checked_count": checked_count,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_kernel_side_adapter_hash_missing_count": 0,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_semantic_adapter_hash_checked_count": checked_count,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_semantic_adapter_hash_missing_count": 0,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_table_object_hash_checked_count": checked_count,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_table_object_hash_missing_count": 0,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_launch_schema_mirror_hash_checked_count": checked_count,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_launch_schema_mirror_hash_missing_count": 0,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_mode": "readonly_kernel_side_typed_consumer_object",
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_mode_checked_count": checked_count,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_mode_missing_count": 0,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_mode_mismatch_count": 0,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_row_count": row_count,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_column_count_max": 4,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_column_count_min": 4,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_table_schema_hash": PREMAP_DESCRIPTOR_CONSUMER_HANDLE_TABLE_SCHEMA_HASH,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_table_schema_hash_checked_count": checked_count,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_table_schema_hash_missing_count": 0,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_table_schema_hash_mismatch_count": 0,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_semantic_schema_hash": PREMAP_KERNEL_ARG_SEMANTIC_HANDLE_SCHEMA_HASH,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_semantic_schema_hash_checked_count": checked_count,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_semantic_schema_hash_missing_count": 0,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_semantic_schema_hash_mismatch_count": 0,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_kernel_side_schema_hash": PREMAP_KERNEL_SIDE_CONSUMER_SCHEMA_HASH,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_kernel_side_schema_hash_checked_count": checked_count,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_kernel_side_schema_hash_missing_count": 0,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_kernel_side_schema_hash_mismatch_count": 0,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_typed_consumer_schema_name": PREMAP_KERNEL_SIDE_TYPED_CONSUMER_SCHEMA_NAME,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_typed_consumer_schema_name_checked_count": checked_count,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_typed_consumer_schema_name_missing_count": 0,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_typed_consumer_schema_name_mismatch_count": 0,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_typed_consumer_schema_hash": PREMAP_KERNEL_SIDE_TYPED_CONSUMER_SCHEMA_HASH,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_typed_consumer_schema_hash_checked_count": checked_count,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_typed_consumer_schema_hash_missing_count": 0,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_typed_consumer_schema_hash_mismatch_count": 0,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_typed_consumer_field_count": checked_count
            * len(PREMAP_KERNEL_SIDE_TYPED_CONSUMER_SCHEMA_FIELDS),
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_required_source_hit_count": row_count * 3,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_required_source_miss_count": 0,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_optional_source_hit_count": row_count,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_optional_source_miss_count": 0,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_handle_field_read_count": row_count * 4,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_consumer_object_present_count": checked_count,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_consumer_connected_count": checked_count
            if consumer_connected
            else 0,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_live_enabled_count": checked_count
            if live_enabled
            else 0,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_live_eligible_count": checked_count
            if live_eligible
            else 0,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_blocked_count": checked_count,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_block_reason": block_reason,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_block_reason_checked_count": checked_count,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_block_reason_missing_count": 0,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_block_reason_mismatch_count": 0,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_payload_bytes": 0,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_payload_violation_count": 0,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_passed_to_kernel_count": 0,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_kernel_arg_violation_count": 0,
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_live_compatible_with_current_wna16_args_count": 0,
        }
    )
    return summary
...
def test_premap_longrun_audit_gate_accepts_kernel_arg_semantic_handle_adapter_contract():
    result = check_summary(
    ...
    assert result["passed"] is True
    assert result["failures"] == []
    assert result["require_kernel_arg_semantic_handle_adapter"] is True
    assert (
        result["metrics"][
    ...
    assert (
        ...
        == 2 * len(PREMAP_KERNEL_ARG_SEMANTIC_HANDLE_SCHEMA_FIELDS)
    )
    assert (
        result["metrics"][
...
def test_premap_longrun_audit_gate_rejects_kernel_arg_semantic_adapter_live_compatibility():
    summary = _add_kernel_arg_semantic_handle_adapter(
        _add_kernel_arg_handoff_launch_schema_mirror(
            _add_kernel_arg_handoff_attempt(_passing_summary())
        )
    )
    ...
    assert result["passed"] is False
    assert (
        "consumer_shim_kernel_arg_semantic_handle_adapter_current_wna16_compatible_count_nonzero=1"
        in result["failures"]
    )
    assert (
...
def test_premap_longrun_audit_gate_accepts_aux_metadata_single_field_canary():
    result = check_summary(
        _add_single_field_handle_handoff_canary(
            _add_kernel_arg_semantic_handle_adapter(
                _add_kernel_arg_handoff_launch_schema_mirror(
        ...
        require_kernel_arg_semantic_handle_adapter=True,
        require_single_field_handle_handoff_canary=True,
        expected_single_field_handle_handoff_canary_field="aux_metadata_handle",
    )
...
def test_premap_longrun_audit_gate_accepts_kernel_side_consumer_schema_adapter_contract():
    result = check_summary(
    ...
    assert result["passed"] is True
    assert result["failures"] == []
    assert result["require_kernel_side_consumer_schema_adapter"] is True
    assert (
        result["metrics"][
    ...
    assert (
        ...
        == 2 * len(PREMAP_KERNEL_SIDE_CONSUMER_SCHEMA_FIELDS)
    )
    assert (
        result["metrics"][
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_consumer_connected_count"
...
def test_premap_longrun_audit_gate_accepts_kernel_side_typed_consumer_object_contract():
    result = check_summary(
    ...
    assert result["passed"] is True
    assert result["failures"] == []
    assert result["require_kernel_side_typed_consumer_object"] is True
    assert (
        result["metrics"][
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_ready_count"
        ]
        == 2
    )
    assert (
    ...
    assert (
        ...
        == 2 * len(PREMAP_KERNEL_SIDE_TYPED_CONSUMER_SCHEMA_FIELDS)
    )
    assert (
        result["metrics"][
            "premap_consumer_descriptor_prep_consumer_shim_kernel_side_typed_consumer_object_passed_to_kernel_count"
        ]
        == 0
    )
...
def test_premap_longrun_audit_gate_report_self_checks_with_typed_consumer():
    result = check_summary(
        ...
        require_kernel_arg_semantic_handle_adapter=True,
        require_single_field_handle_handoff_canary=True,
        expected_single_field_handle_handoff_canary_field="scale_metadata_handle",
        require_kernel_side_consumer_schema_adapter=True,
        require_kernel_side_typed_consumer_object=True,
        require_native_typed_consumer_bridge=True,
    )
...
def test_premap_longrun_audit_gate_report_self_check_rejects_missing_canary_metric():
    result = check_summary(
        _add_single_field_handle_handoff_canary(
            _add_kernel_arg_semantic_handle_adapter(
                _add_kernel_arg_handoff_launch_schema_mirror(
    ...
    assert (
        "consumer_shim_single_field_handle_handoff_canary_mirror_source_field_missing"
        in self_check["failures"]
    )
...
def test_premap_longrun_audit_gate_rejects_typed_consumer_payload_or_kernel_pass():
    ...
    assert result["passed"] is False
    assert (
        "consumer_shim_kernel_side_typed_consumer_object_payload_bytes_nonzero=1"
        in result["failures"]
    )
    assert (
        "consumer_shim_kernel_side_typed_consumer_object_passed_to_kernel_count_nonzero=1"
        in result["failures"]
    )


def test_premap_longrun_audit_gate_requires_typed_consumer_schema_dependency():
    result = check_summary(
        _add_kernel_side_typed_consumer_object(
            _add_kernel_arg_semantic_handle_adapter(
                _add_kernel_arg_handoff_launch_schema_mirror(
...
def test_premap_longrun_audit_gate_requires_kernel_side_consumer_schema_dependency():
    result = check_summary(
        _add_kernel_side_consumer_schema_adapter(
            _add_kernel_arg_handoff_launch_schema_mirror(
                _add_kernel_arg_handoff_attempt(_passing_summary())
...
def test_premap_longrun_audit_gate_requires_kernel_arg_semantic_adapter_explicitly():
    result = check_summary(
        _add_kernel_arg_handoff_launch_schema_mirror(
            _add_kernel_arg_handoff_attempt(_passing_summary())
        ),
...
def test_premap_longrun_audit_gate_rejects_semantic_adapter_without_launch_schema_mirror():
    result = check_summary(
        _add_kernel_arg_semantic_handle_adapter(
            _add_kernel_arg_handoff_attempt(_passing_summary())
        ),
...
def test_premap_longrun_audit_gate_rejects_prepared_table_source_without_allow():
    result = check_summary(
        _add_kernel_arg_handoff_live_consumer_adapter(
            _add_kernel_arg_handoff_live_noop_integration(
                _add_kernel_arg_handoff_live_toggle(
...
def test_premap_longrun_audit_gate_rejects_prepared_table_source_without_dry_run():
    summary = _add_kernel_arg_handoff_live_consumer_adapter(
        _add_kernel_arg_handoff_live_noop_integration(
            _add_kernel_arg_handoff_live_toggle(
                _add_kernel_arg_handoff_launch_schema_mirror(
...
def test_premap_longrun_audit_gate_accepts_prepared_table_source_dry_run():
    result = check_summary(
        _add_kernel_arg_handoff_live_consumer_adapter(
            _add_kernel_arg_handoff_live_noop_integration(
                _add_kernel_arg_handoff_live_toggle(
