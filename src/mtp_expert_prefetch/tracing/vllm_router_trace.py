...
RUNTIME_SHADOW_AGGREGATE_PERFORMANCE_KEYS = (
    ...
    "premap_consumer_descriptor_prep_consumer_shim_kernel_arg_handoff_launch_schema_mirror_table_schema_hash_checked_count",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_arg_handoff_launch_schema_mirror_table_schema_hash_missing_count",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_arg_handoff_launch_schema_mirror_table_schema_hash_mismatch_count",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_arg_handoff_launch_schema_mirror_launch_schema_name",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_arg_handoff_launch_schema_mirror_launch_schema_name_checked_count",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_arg_handoff_launch_schema_mirror_launch_schema_name_missing_count",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_arg_handoff_launch_schema_mirror_launch_schema_name_mismatch_count",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_arg_handoff_launch_schema_mirror_launch_schema_hash",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_arg_handoff_launch_schema_mirror_launch_schema_hash_checked_count",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_arg_handoff_launch_schema_mirror_launch_schema_hash_missing_count",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_arg_handoff_launch_schema_mirror_launch_schema_hash_mismatch_count",
    ...
    "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_hash_missing_count",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_semantic_adapter_hash_checked_count",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_semantic_adapter_hash_missing_count",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_table_object_hash_checked_count",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_table_object_hash_missing_count",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_launch_schema_mirror_hash_checked_count",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_launch_schema_mirror_hash_missing_count",
    ...
    "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_column_count_min",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_table_schema_hash",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_table_schema_hash_checked_count",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_table_schema_hash_missing_count",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_table_schema_hash_mismatch_count",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_semantic_schema_hash",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_semantic_schema_hash_checked_count",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_semantic_schema_hash_missing_count",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_semantic_schema_hash_mismatch_count",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_kernel_side_schema_name",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_kernel_side_schema_name_checked_count",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_kernel_side_schema_name_missing_count",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_kernel_side_schema_name_mismatch_count",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_kernel_side_schema_hash",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_kernel_side_schema_hash_checked_count",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_kernel_side_schema_hash_missing_count",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_kernel_side_schema_hash_mismatch_count",
    ...
    "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_block_reason_checked_count",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_block_reason_missing_count",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_block_reason_mismatch_count",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_payload_bytes",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_payload_violation_count",
    ...
    "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_live_compatible_with_current_wna16_args_count",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_mode",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_mode_checked_count",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_mode_missing_count",
    "premap_consumer_descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_mode_mismatch_count",
            ...
            sink.write_premap_consumer_mapping(
                ...
                **self._premap_payload_cache_ready_time_kwargs(payload_cache_snapshot),
                ...
                descriptor_prep_consumer_shim_kernel_arg_handoff_shadow_slot_mode=(
                    descriptor_consumer_shim_result.kernel_arg_handoff_shadow_slot_mode
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_shadow_slot_ready=(
                    descriptor_consumer_shim_result.kernel_arg_handoff_shadow_slot_ready
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_shadow_slot_hash=(
                    descriptor_consumer_shim_result.kernel_arg_handoff_shadow_slot_hash
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_shadow_slot_table_object_hash=(
                    descriptor_consumer_shim_result.kernel_arg_handoff_shadow_slot_table_object_hash
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_shadow_slot_row_count=(
                    int(
                        descriptor_consumer_shim_result.kernel_arg_handoff_shadow_slot_row_count
                    )
                    if (
                        descriptor_consumer_shim_result is not None
                        and descriptor_consumer_shim_result.kernel_arg_handoff_shadow_slot_row_count
                        is not None
                    )
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_shadow_slot_column_count=(
                    int(
                        descriptor_consumer_shim_result.kernel_arg_handoff_shadow_slot_column_count
                    )
                    if (
                        descriptor_consumer_shim_result is not None
                        and descriptor_consumer_shim_result.kernel_arg_handoff_shadow_slot_column_count
                        is not None
                    )
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_shadow_slot_schema_hash=(
                    descriptor_consumer_shim_result.kernel_arg_handoff_shadow_slot_schema_hash
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_shadow_slot_required_source_hit_count=(
                    int(
                        descriptor_consumer_shim_result.kernel_arg_handoff_shadow_slot_required_source_hit_count
                    )
                    if (
                        descriptor_consumer_shim_result is not None
                        and descriptor_consumer_shim_result.kernel_arg_handoff_shadow_slot_required_source_hit_count
                        is not None
                    )
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_shadow_slot_required_source_miss_count=(
                    int(
                        descriptor_consumer_shim_result.kernel_arg_handoff_shadow_slot_required_source_miss_count
                    )
                    if (
                        descriptor_consumer_shim_result is not None
                        and descriptor_consumer_shim_result.kernel_arg_handoff_shadow_slot_required_source_miss_count
                        is not None
                    )
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_shadow_slot_optional_source_hit_count=(
                    int(
                        descriptor_consumer_shim_result.kernel_arg_handoff_shadow_slot_optional_source_hit_count
                    )
                    if (
                        descriptor_consumer_shim_result is not None
                        and descriptor_consumer_shim_result.kernel_arg_handoff_shadow_slot_optional_source_hit_count
                        is not None
                    )
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_shadow_slot_optional_source_miss_count=(
                    int(
                        descriptor_consumer_shim_result.kernel_arg_handoff_shadow_slot_optional_source_miss_count
                    )
                    if (
                        descriptor_consumer_shim_result is not None
                        and descriptor_consumer_shim_result.kernel_arg_handoff_shadow_slot_optional_source_miss_count
                        is not None
                    )
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_shadow_slot_payload_bytes=(
                    int(
                        descriptor_consumer_shim_result.kernel_arg_handoff_shadow_slot_payload_bytes
                    )
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_shadow_slot_passed_to_kernel=(
                    bool(
                        descriptor_consumer_shim_result.kernel_arg_handoff_shadow_slot_passed_to_kernel
                    )
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_shadow_slot_changes_kernel_launch_args=(
                    bool(
                        descriptor_consumer_shim_result.kernel_arg_handoff_shadow_slot_changes_kernel_launch_args
                    )
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_mirror_mode=(
                    descriptor_consumer_shim_result.kernel_arg_handoff_mirror_mode
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_mirror_ready=(
                    descriptor_consumer_shim_result.kernel_arg_handoff_mirror_ready
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_mirror_hash=(
                    descriptor_consumer_shim_result.kernel_arg_handoff_mirror_hash
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_mirror_slot_hash=(
                    descriptor_consumer_shim_result.kernel_arg_handoff_mirror_slot_hash
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_mirror_table_object_hash=(
                    descriptor_consumer_shim_result.kernel_arg_handoff_mirror_table_object_hash
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_mirror_row_count=(
                    int(
                        descriptor_consumer_shim_result.kernel_arg_handoff_mirror_row_count
                    )
                    if (
                        descriptor_consumer_shim_result is not None
                        and descriptor_consumer_shim_result.kernel_arg_handoff_mirror_row_count
                        is not None
                    )
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_mirror_column_count=(
                    int(
                        descriptor_consumer_shim_result.kernel_arg_handoff_mirror_column_count
                    )
                    if (
                        descriptor_consumer_shim_result is not None
                        and descriptor_consumer_shim_result.kernel_arg_handoff_mirror_column_count
                        is not None
                    )
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_mirror_schema_hash=(
                    descriptor_consumer_shim_result.kernel_arg_handoff_mirror_schema_hash
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_mirror_required_source_hit_count=(
                    int(
                        descriptor_consumer_shim_result.kernel_arg_handoff_mirror_required_source_hit_count
                    )
                    if (
                        descriptor_consumer_shim_result is not None
                        and descriptor_consumer_shim_result.kernel_arg_handoff_mirror_required_source_hit_count
                        is not None
                    )
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_mirror_required_source_miss_count=(
                    int(
                        descriptor_consumer_shim_result.kernel_arg_handoff_mirror_required_source_miss_count
                    )
                    if (
                        descriptor_consumer_shim_result is not None
                        and descriptor_consumer_shim_result.kernel_arg_handoff_mirror_required_source_miss_count
                        is not None
                    )
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_mirror_optional_source_hit_count=(
                    int(
                        descriptor_consumer_shim_result.kernel_arg_handoff_mirror_optional_source_hit_count
                    )
                    if (
                        descriptor_consumer_shim_result is not None
                        and descriptor_consumer_shim_result.kernel_arg_handoff_mirror_optional_source_hit_count
                        is not None
                    )
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_mirror_optional_source_miss_count=(
                    int(
                        descriptor_consumer_shim_result.kernel_arg_handoff_mirror_optional_source_miss_count
                    )
                    if (
                        descriptor_consumer_shim_result is not None
                        and descriptor_consumer_shim_result.kernel_arg_handoff_mirror_optional_source_miss_count
                        is not None
                    )
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_mirror_payload_bytes=(
                    int(
                        descriptor_consumer_shim_result.kernel_arg_handoff_mirror_payload_bytes
                    )
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_mirror_passed_to_kernel=(
                    bool(
                        descriptor_consumer_shim_result.kernel_arg_handoff_mirror_passed_to_kernel
                    )
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                ...
                descriptor_prep_consumer_shim_kernel_arg_handoff_launch_schema_mirror_mode=(
                    descriptor_consumer_shim_result.kernel_arg_handoff_launch_schema_mirror_mode
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_launch_schema_mirror_ready=(
                    descriptor_consumer_shim_result.kernel_arg_handoff_launch_schema_mirror_ready
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_launch_schema_mirror_hash=(
                    descriptor_consumer_shim_result.kernel_arg_handoff_launch_schema_mirror_hash
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_launch_schema_mirror_handoff_mirror_hash=(
                    descriptor_consumer_shim_result.kernel_arg_handoff_launch_schema_mirror_handoff_mirror_hash
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_launch_schema_mirror_slot_hash=(
                    descriptor_consumer_shim_result.kernel_arg_handoff_launch_schema_mirror_slot_hash
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_launch_schema_mirror_table_object_hash=(
                    descriptor_consumer_shim_result.kernel_arg_handoff_launch_schema_mirror_table_object_hash
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_launch_schema_mirror_row_count=(
                    int(
                        descriptor_consumer_shim_result.kernel_arg_handoff_launch_schema_mirror_row_count
                    )
                    if (
                        descriptor_consumer_shim_result is not None
                        and descriptor_consumer_shim_result.kernel_arg_handoff_launch_schema_mirror_row_count
                        is not None
                    )
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_launch_schema_mirror_column_count=(
                    int(
                        descriptor_consumer_shim_result.kernel_arg_handoff_launch_schema_mirror_column_count
                    )
                    if (
                        descriptor_consumer_shim_result is not None
                        and descriptor_consumer_shim_result.kernel_arg_handoff_launch_schema_mirror_column_count
                        is not None
                    )
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_launch_schema_mirror_table_schema_hash=(
                    descriptor_consumer_shim_result.kernel_arg_handoff_launch_schema_mirror_table_schema_hash
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_launch_schema_mirror_launch_schema_name=(
                    descriptor_consumer_shim_result.kernel_arg_handoff_launch_schema_mirror_launch_schema_name
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_launch_schema_mirror_launch_schema_hash=(
                    descriptor_consumer_shim_result.kernel_arg_handoff_launch_schema_mirror_launch_schema_hash
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_launch_schema_mirror_launch_arg_field_count=(
                    int(
                        descriptor_consumer_shim_result.kernel_arg_handoff_launch_schema_mirror_launch_arg_field_count
                    )
                    if (
                        descriptor_consumer_shim_result is not None
                        and descriptor_consumer_shim_result.kernel_arg_handoff_launch_schema_mirror_launch_arg_field_count
                        is not None
                    )
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_launch_schema_mirror_required_source_hit_count=(
                    int(
                        descriptor_consumer_shim_result.kernel_arg_handoff_launch_schema_mirror_required_source_hit_count
                    )
                    if (
                        descriptor_consumer_shim_result is not None
                        and descriptor_consumer_shim_result.kernel_arg_handoff_launch_schema_mirror_required_source_hit_count
                        is not None
                    )
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_launch_schema_mirror_required_source_miss_count=(
                    int(
                        descriptor_consumer_shim_result.kernel_arg_handoff_launch_schema_mirror_required_source_miss_count
                    )
                    if (
                        descriptor_consumer_shim_result is not None
                        and descriptor_consumer_shim_result.kernel_arg_handoff_launch_schema_mirror_required_source_miss_count
                        is not None
                    )
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_launch_schema_mirror_optional_source_hit_count=(
                    int(
                        descriptor_consumer_shim_result.kernel_arg_handoff_launch_schema_mirror_optional_source_hit_count
                    )
                    if (
                        descriptor_consumer_shim_result is not None
                        and descriptor_consumer_shim_result.kernel_arg_handoff_launch_schema_mirror_optional_source_hit_count
                        is not None
                    )
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_launch_schema_mirror_optional_source_miss_count=(
                    int(
                        descriptor_consumer_shim_result.kernel_arg_handoff_launch_schema_mirror_optional_source_miss_count
                    )
                    if (
                        descriptor_consumer_shim_result is not None
                        and descriptor_consumer_shim_result.kernel_arg_handoff_launch_schema_mirror_optional_source_miss_count
                        is not None
                    )
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_launch_schema_mirror_handle_field_read_count=(
                    int(
                        descriptor_consumer_shim_result.kernel_arg_handoff_launch_schema_mirror_handle_field_read_count
                    )
                    if (
                        descriptor_consumer_shim_result is not None
                        and descriptor_consumer_shim_result.kernel_arg_handoff_launch_schema_mirror_handle_field_read_count
                        is not None
                    )
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_launch_schema_mirror_payload_bytes=(
                    int(
                        descriptor_consumer_shim_result.kernel_arg_handoff_launch_schema_mirror_payload_bytes
                    )
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_launch_schema_mirror_passed_to_kernel=(
                    bool(
                        descriptor_consumer_shim_result.kernel_arg_handoff_launch_schema_mirror_passed_to_kernel
                    )
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_launch_schema_mirror_changes_kernel_launch_args=(
                    bool(
                        descriptor_consumer_shim_result.kernel_arg_handoff_launch_schema_mirror_changes_kernel_launch_args
                    )
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                ...
                descriptor_prep_consumer_shim_kernel_arg_handoff_live_consumer_adapter_mode=(
                    descriptor_consumer_shim_result.kernel_arg_handoff_live_consumer_adapter_mode
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                ...
                descriptor_prep_consumer_shim_kernel_arg_handoff_live_consumer_adapter_live_noop_integration_hash=(
                    descriptor_consumer_shim_result.kernel_arg_handoff_live_consumer_adapter_live_noop_integration_hash
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                ...
                descriptor_prep_consumer_shim_kernel_arg_handoff_live_consumer_adapter_enabled=(
                    descriptor_consumer_shim_result.kernel_arg_handoff_live_consumer_adapter_enabled
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_live_consumer_adapter_lab_gate_passed=(
                    descriptor_consumer_shim_result.kernel_arg_handoff_live_consumer_adapter_lab_gate_passed
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_live_consumer_adapter_live_noop_integration_record_ready=(
                    descriptor_consumer_shim_result.kernel_arg_handoff_live_consumer_adapter_live_noop_integration_record_ready
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_live_consumer_adapter_live_noop_integration_blocked=(
                    descriptor_consumer_shim_result.kernel_arg_handoff_live_consumer_adapter_live_noop_integration_blocked
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_live_consumer_adapter_live_noop_integration_block_reason=(
                    descriptor_consumer_shim_result.kernel_arg_handoff_live_consumer_adapter_live_noop_integration_block_reason
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_live_consumer_adapter_consumer_adapter_present=(
                    descriptor_consumer_shim_result.kernel_arg_handoff_live_consumer_adapter_consumer_adapter_present
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_live_consumer_adapter_consumer_connected=(
                    descriptor_consumer_shim_result.kernel_arg_handoff_live_consumer_adapter_consumer_connected
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_live_consumer_adapter_live_eligible=(
                    descriptor_consumer_shim_result.kernel_arg_handoff_live_consumer_adapter_live_eligible
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_live_consumer_adapter_blocked=(
                    descriptor_consumer_shim_result.kernel_arg_handoff_live_consumer_adapter_blocked
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                ...
                descriptor_prep_consumer_shim_kernel_arg_handoff_live_consumer_adapter_payload_bytes=(
                    int(
                        descriptor_consumer_shim_result.kernel_arg_handoff_live_consumer_adapter_payload_bytes
                    )
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_arg_handoff_live_consumer_adapter_passed_to_kernel=(
                    bool(
                        descriptor_consumer_shim_result.kernel_arg_handoff_live_consumer_adapter_passed_to_kernel
                    )
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                ...
                descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_ready=(
                    descriptor_consumer_shim_result.kernel_side_consumer_schema_adapter_ready
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_hash=(
                    descriptor_consumer_shim_result.kernel_side_consumer_schema_adapter_hash
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_semantic_adapter_hash=(
                    descriptor_consumer_shim_result.kernel_side_consumer_schema_adapter_semantic_adapter_hash
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_table_object_hash=(
                    descriptor_consumer_shim_result.kernel_side_consumer_schema_adapter_table_object_hash
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_launch_schema_mirror_hash=(
                    descriptor_consumer_shim_result.kernel_side_consumer_schema_adapter_launch_schema_mirror_hash
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_row_count=(
                    int(
                        descriptor_consumer_shim_result.kernel_side_consumer_schema_adapter_row_count
                    )
                    if (
                        descriptor_consumer_shim_result is not None
                        and descriptor_consumer_shim_result.kernel_side_consumer_schema_adapter_row_count
                        is not None
                    )
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_column_count=(
                    int(
                        descriptor_consumer_shim_result.kernel_side_consumer_schema_adapter_column_count
                    )
                    if (
                        descriptor_consumer_shim_result is not None
                        and descriptor_consumer_shim_result.kernel_side_consumer_schema_adapter_column_count
                        is not None
                    )
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_table_schema_hash=(
                    descriptor_consumer_shim_result.kernel_side_consumer_schema_adapter_table_schema_hash
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_semantic_schema_hash=(
                    descriptor_consumer_shim_result.kernel_side_consumer_schema_adapter_semantic_schema_hash
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_kernel_side_schema_name=(
                    descriptor_consumer_shim_result.kernel_side_consumer_schema_adapter_kernel_side_schema_name
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_kernel_side_schema_hash=(
                    descriptor_consumer_shim_result.kernel_side_consumer_schema_adapter_kernel_side_schema_hash
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_kernel_side_field_count=(
                    int(
                        descriptor_consumer_shim_result.kernel_side_consumer_schema_adapter_kernel_side_field_count
                    )
                    if (
                        descriptor_consumer_shim_result is not None
                        and descriptor_consumer_shim_result.kernel_side_consumer_schema_adapter_kernel_side_field_count
                        is not None
                    )
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_required_source_hit_count=(
                    int(
                        descriptor_consumer_shim_result.kernel_side_consumer_schema_adapter_required_source_hit_count
                    )
                    if (
                        descriptor_consumer_shim_result is not None
                        and descriptor_consumer_shim_result.kernel_side_consumer_schema_adapter_required_source_hit_count
                        is not None
                    )
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_required_source_miss_count=(
                    int(
                        descriptor_consumer_shim_result.kernel_side_consumer_schema_adapter_required_source_miss_count
                    )
                    if (
                        descriptor_consumer_shim_result is not None
                        and descriptor_consumer_shim_result.kernel_side_consumer_schema_adapter_required_source_miss_count
                        is not None
                    )
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_optional_source_hit_count=(
                    int(
                        descriptor_consumer_shim_result.kernel_side_consumer_schema_adapter_optional_source_hit_count
                    )
                    if (
                        descriptor_consumer_shim_result is not None
                        and descriptor_consumer_shim_result.kernel_side_consumer_schema_adapter_optional_source_hit_count
                        is not None
                    )
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_optional_source_miss_count=(
                    int(
                        descriptor_consumer_shim_result.kernel_side_consumer_schema_adapter_optional_source_miss_count
                    )
                    if (
                        descriptor_consumer_shim_result is not None
                        and descriptor_consumer_shim_result.kernel_side_consumer_schema_adapter_optional_source_miss_count
                        is not None
                    )
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_handle_field_read_count=(
                    int(
                        descriptor_consumer_shim_result.kernel_side_consumer_schema_adapter_handle_field_read_count
                    )
                    if (
                        descriptor_consumer_shim_result is not None
                        and descriptor_consumer_shim_result.kernel_side_consumer_schema_adapter_handle_field_read_count
                        is not None
                    )
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_consumer_schema_present=(
                    bool(
                        descriptor_consumer_shim_result.kernel_side_consumer_schema_adapter_consumer_schema_present
                    )
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_consumer_connected=(
                    bool(
                        descriptor_consumer_shim_result.kernel_side_consumer_schema_adapter_consumer_connected
                    )
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_live_enabled=(
                    bool(
                        descriptor_consumer_shim_result.kernel_side_consumer_schema_adapter_live_enabled
                    )
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_live_eligible=(
                    bool(
                        descriptor_consumer_shim_result.kernel_side_consumer_schema_adapter_live_eligible
                    )
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_blocked=(
                    bool(
                        descriptor_consumer_shim_result.kernel_side_consumer_schema_adapter_blocked
                    )
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_block_reason=(
                    descriptor_consumer_shim_result.kernel_side_consumer_schema_adapter_block_reason
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_payload_bytes=(
                    int(
                        descriptor_consumer_shim_result.kernel_side_consumer_schema_adapter_payload_bytes
                    )
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_passed_to_kernel=(
                    bool(
                        descriptor_consumer_shim_result.kernel_side_consumer_schema_adapter_passed_to_kernel
                    )
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_changes_kernel_launch_args=(
                    bool(
                        descriptor_consumer_shim_result.kernel_side_consumer_schema_adapter_changes_kernel_launch_args
                    )
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_consumer_schema_adapter_live_compatible_with_current_wna16_args=(
                    bool(
                        descriptor_consumer_shim_result.kernel_side_consumer_schema_adapter_live_compatible_with_current_wna16_args
                    )
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                ...
                descriptor_prep_consumer_shim_kernel_side_typed_row_consumer_path_mode=(
                    descriptor_consumer_shim_result.kernel_side_typed_row_consumer_path_mode
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_typed_row_consumer_path_name=(
                    descriptor_consumer_shim_result.kernel_side_typed_row_consumer_path_name
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_typed_row_consumer_path_source=(
                    descriptor_consumer_shim_result.kernel_side_typed_row_consumer_path_source
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_typed_row_consumer_path_checked=(
                    descriptor_consumer_shim_result.kernel_side_typed_row_consumer_path_checked
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_typed_row_consumer_path_ready=(
                    descriptor_consumer_shim_result.kernel_side_typed_row_consumer_path_ready
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_typed_row_consumer_path_input_hash=(
                    descriptor_consumer_shim_result.kernel_side_typed_row_consumer_path_input_hash
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_typed_row_consumer_path_table_object_hash=(
                    descriptor_consumer_shim_result.kernel_side_typed_row_consumer_path_table_object_hash
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_typed_row_consumer_path_schema_hash=(
                    descriptor_consumer_shim_result.kernel_side_typed_row_consumer_path_schema_hash
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_typed_row_consumer_path_row_count=(
                    int(
                        descriptor_consumer_shim_result.kernel_side_typed_row_consumer_path_row_count
                    )
                    if (
                        descriptor_consumer_shim_result is not None
                        and descriptor_consumer_shim_result.kernel_side_typed_row_consumer_path_row_count
                        is not None
                    )
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_typed_row_consumer_path_column_count=(
                    int(
                        descriptor_consumer_shim_result.kernel_side_typed_row_consumer_path_column_count
                    )
                    if (
                        descriptor_consumer_shim_result is not None
                        and descriptor_consumer_shim_result.kernel_side_typed_row_consumer_path_column_count
                        is not None
                    )
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_typed_row_consumer_path_row_ok_count=(
                    int(
                        descriptor_consumer_shim_result.kernel_side_typed_row_consumer_path_row_ok_count
                    )
                    if (
                        descriptor_consumer_shim_result is not None
                        and descriptor_consumer_shim_result.kernel_side_typed_row_consumer_path_row_ok_count
                        is not None
                    )
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_typed_row_consumer_path_error_count=(
                    int(
                        descriptor_consumer_shim_result.kernel_side_typed_row_consumer_path_error_count
                    )
                    if (
                        descriptor_consumer_shim_result is not None
                        and descriptor_consumer_shim_result.kernel_side_typed_row_consumer_path_error_count
                        is not None
                    )
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_typed_row_consumer_path_hash_accumulator=(
                    descriptor_consumer_shim_result.kernel_side_typed_row_consumer_path_hash_accumulator
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_typed_row_consumer_path_failure_count=(
                    int(
                        descriptor_consumer_shim_result.kernel_side_typed_row_consumer_path_failure_count
                    )
                    if (
                        descriptor_consumer_shim_result is not None
                        and descriptor_consumer_shim_result.kernel_side_typed_row_consumer_path_failure_count
                        is not None
                    )
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_typed_row_consumer_path_failures=(
                    descriptor_consumer_shim_result.kernel_side_typed_row_consumer_path_failures
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_typed_row_consumer_path_payload_bytes=(
                    int(
                        descriptor_consumer_shim_result.kernel_side_typed_row_consumer_path_payload_bytes
                    )
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_typed_row_consumer_path_passed_to_kernel=(
                    bool(
                        descriptor_consumer_shim_result.kernel_side_typed_row_consumer_path_passed_to_kernel
                    )
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                descriptor_prep_consumer_shim_kernel_side_typed_row_consumer_path_changes_kernel_launch_args=(
                    bool(
                        descriptor_consumer_shim_result.kernel_side_typed_row_consumer_path_changes_kernel_launch_args
                    )
                    if descriptor_consumer_shim_result is not None
                    else None
                ),
                ...
                descriptor_prep_consumer_shim_prep_execution_dry_run_handle_field_read_count=(
                    int(
                        descriptor_consumer_shim_result.prep_execution_dry_run_handle_field_read_count
                    )
                    if (
                        descriptor_consumer_shim_result is not None
                        and descriptor_consumer_shim_result.prep_execution_dry_run_handle_field_read_count
                        is not None
                    )
                    else None
                ),
                descriptor_prep_consumer_shim_prep_execution_dry_run_required_handle_field_available_count=(
                    int(
                        descriptor_consumer_shim_result.prep_execution_dry_run_required_handle_field_available_count
                    )
                    if (
                        descriptor_consumer_shim_result is not None
                        and descriptor_consumer_shim_result.prep_execution_dry_run_required_handle_field_available_count
                        is not None
                    )
                    else None
                ),
                descriptor_prep_consumer_shim_prep_execution_dry_run_optional_handle_field_available_count=(
                    int(
                        descriptor_consumer_shim_result.prep_execution_dry_run_optional_handle_field_available_count
                    )
                    if (
                        descriptor_consumer_shim_result is not None
            ...
            try:
                ...
                if use_live_mutation_package:
                    ...
                    if bool(
                        ...
                        gpu_assignment_validation_mode = "identity"
                        if recorder_for_config is not None:
                            gpu_assignment_validation_mode = str(
                                recorder_for_config.shadow_premap_kernel_arg_handoff_gpu_assignment_validation_mode
                            ).strip().lower()
                        live_mutation_package_meta[
                            "producer_gpu_assignment_consumer_validation_mode"
                        ] = gpu_assignment_validation_mode
                        if gpu_assignment_validation_mode == "trusted_refs":
                            _increment_premap_kernel_arg_live_mutation_counter(
                                "gpu_assignment_trusted_refs_seen_count"
                            )
                            gpu_assignment_available = bool(
                                live_mutation_package_meta.get(
                                    "producer_gpu_assignment_available", False
                                )
                            )
                            if gpu_assignment_available:
                                _increment_premap_kernel_arg_live_mutation_counter(
                                    "gpu_assignment_trusted_refs_available_count"
                                )
                            else:
                                _increment_premap_kernel_arg_live_mutation_counter(
...
def _apply_premap_consumer_readonly_gate(
    ...
    *,
    ...
    if (
        ...
        raise ValueError(msg)
    allowed_gpu_assignment_validation_modes = {"identity", "trusted_refs"}
    if gpu_assignment_validation_mode not in allowed_gpu_assignment_validation_modes:
        msg = (
            "premap_kernel_arg_handoff_gpu_assignment_validation_mode must be "
            f"one of {sorted(allowed_gpu_assignment_validation_modes)}; got "
            f"{gpu_assignment_validation_mode!r}."
        )
        raise ValueError(msg)
    ...
    if (
        gpu_assignment_kernel_variant_enabled
        and gpu_assignment_validation_mode != "identity"
    ):
        msg = (
            "premap_kernel_arg_handoff_gpu_assignment_kernel_variant_enabled=True "
    ...
    if descriptor_prep_mode is not None:
        ...
        if check.get("require_consumer_shim_table_consume") is not True:
            ...
            raise ValueError(msg)
        if check.get("require_consumer_shim_table_object") is not True:
            msg = (
                "premap_descriptor_prep_execution_mode requires a readonly gate "
                f"checked with require_consumer_shim_table_object=true: {path}"
            )
            raise ValueError(msg)
        if check.get("require_consumer_shim_prep_execution") is not True:
            msg = (
                "premap_descriptor_prep_execution_mode requires a readonly gate "
                f"checked with require_consumer_shim_prep_execution=true: {path}"
            )
            raise ValueError(msg)
        launch_schema_mirror_required = bool(
            contract.get("kernel_arg_handoff_launch_schema_mirror_required", False)
        )
        if launch_schema_mirror_required:
            expected_launch_schema_contract = {
                ...
                "kernel_arg_handoff_launch_schema_mirror_passed_to_kernel_required": (
                    False
                ),
                "kernel_arg_handoff_launch_schema_mirror_changes_kernel_launch_args_required": (
                    False
                ),
            }
            for key, expected in expected_launch_schema_contract.items():
                observed = contract.get(key)
                if observed != expected:
                    msg = (
                        "Premap consumer readonly gate violates the launch-schema "
                        f"mirror contract for {path}: {key}={observed!r} != "
                        f"{expected!r}"
                    )
                    raise ValueError(msg)
            if check.get("require_kernel_arg_handoff_launch_schema_mirror") is not True:
                msg = (
                    "kernel-arg handoff launch-schema mirror requires a readonly "
                    "gate checked with "
                    f"require_kernel_arg_handoff_launch_schema_mirror=true: {path}"
                )
                raise ValueError(msg)
    ...
    if bool(semantic_adapter_required_raw):
        ...
        if check.get("require_kernel_arg_semantic_handle_adapter") is not True:
            ...
            raise ValueError(msg)
    kernel_side_schema_adapter_required_raw = contract.get(
        "kernel_side_consumer_schema_adapter_required",
        False,
    )
    if not isinstance(kernel_side_schema_adapter_required_raw, bool):
        msg = (
            "Premap consumer readonly gate "
            "contract.kernel_side_consumer_schema_adapter_required must be "
            f"boolean when present: {path}"
        )
        raise TypeError(msg)
    if bool(kernel_side_schema_adapter_required_raw):
        if lab_precondition is not True:
            msg = (
                "kernel-side consumer schema adapter requires a readonly gate "
                f"with lab_precondition=true: {path}"
            )
            raise ValueError(msg)
        if not bool(contract.get("kernel_arg_semantic_handle_adapter_required")):
            msg = (
                "kernel-side consumer schema adapter requires "
                "contract.kernel_arg_semantic_handle_adapter_required=true: "
                f"{path}"
            )
            raise ValueError(msg)
        ...
        kernel_side_contract = {
            ...
            "kernel_side_consumer_schema_adapter_kernel_side_field_count_required": len(
                PREMAP_KERNEL_SIDE_CONSUMER_SCHEMA_FIELDS
            ),
            "kernel_side_consumer_schema_adapter_column_count_required": len(
                PREMAP_DESCRIPTOR_CONSUMER_HANDLE_TABLE_COLUMNS
            ),
            ...
            "kernel_side_consumer_schema_adapter_changes_kernel_launch_args_required": (
                False
            ),
        ...
        for key, expected in kernel_side_contract.items():
            ...
            if observed != expected:
                msg = (
                    "Premap consumer readonly gate violates the kernel-side "
                    f"consumer schema adapter contract for {path}: "
                    f"{key}={observed!r} != {expected!r}"
                )
                raise ValueError(msg)
        check = gate.get("check", {})
        if not isinstance(check, dict):
            msg = f"Premap consumer readonly gate `gate.check` must be a mapping: {path}"
            raise TypeError(msg)
        if check.get("require_kernel_side_consumer_schema_adapter") is not True:
            msg = (
                "kernel-side consumer schema adapter requires a readonly gate "
                "checked with require_kernel_side_consumer_schema_adapter=true: "
                f"{path}"
            )
            raise ValueError(msg)
